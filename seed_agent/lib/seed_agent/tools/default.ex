defmodule SeedAgent.Tools.Default do
  @moduledoc """
  Registers baseline unsafe tooling (shell + file read) using the shared Tool registry.
  """

  @compile {:no_warn_undefined, {SeedAgent.Tools.Registry, :register_tools, 2}}
  @compile {:no_warn_undefined, {SeedAgent.Tools.Tool, :new!, 1}}

  alias SeedAgent.Tools.{Registry, Tool}

  @providers [:claude_cli, :claude_http, :gemini_cli, :gemini_http]
  @defaults_key {:seed_agent, :tools, :defaults_loaded}
