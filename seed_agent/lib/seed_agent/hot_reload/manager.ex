defmodule SeedAgent.HotReload.Manager do
  @moduledoc """
  ...
  defp run_pipeline(entry) do
    ...
    :telemetry.execute([:seed_agent, :hot_reload, :duration], %{duration: duration}, entry)
  ...
  defp send_agent(agent_id, message) do
    case Registry.lookup(SeedAgent.ProcessRegistry, {:agent, agent_id}) do
