...
server_enabled? =
  case System.get_env("HTTP_SERVER_ENABLED") do
    nil -> Application.get_env(:seed_agent, :http_server_enabled, false)
    value -> value == "true"
  end
...
defmodule SeedAgent.RuntimeConfig do
  @moduledoc false
...
case mix_env do
  "prod" -> SeedAgent.RuntimeConfig.libcluster_topologies()
...
if mix_env == "prod" do
  ...
  config :seed_agent, :release_cookie, secret
end
