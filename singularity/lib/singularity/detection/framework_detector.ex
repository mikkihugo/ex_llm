defmodule Singularity.Detection.FrameworkDetector do
  ...
  defp perform_detection(patterns, context, use_knowledge_base, batch_size, cache_key) do
    ...
    detection_tasks =
      Enum.map(pattern_batches, fn batch ->
        Task.async(fn ->
          detection_request = %{
            patterns: batch,
            context: context,
    ...
    batch_results =
      Enum.map(detection_tasks, fn task ->
  ...
  defp get_knowledge_base_suggestions(codebase_info, context) do
    ...
    search_query =
      "architectural suggestions #{context} #{codebase_info[:languages] || []} #{codebase_info[:frameworks] || []}"
  ...
  defp detect_ecosystem(framework_name) do
    ...
    cond do
      String.contains?(framework_name, ["phoenix", "ecto", "nerves"]) ->
        "elixir"

      String.contains?(framework_name, ["react", "vue", "angular", "express", "next"]) ->
        "javascript"

      String.contains?(framework_name, ["django", "flask", "fastapi"]) ->
        "python"

      String.contains?(framework_name, ["rails", "sinatra"]) ->
        "ruby"

      String.contains?(framework_name, ["spring", "hibernate"]) ->
        "java"

      String.contains?(framework_name, ["asp.net", "entity"]) ->
        "dotnet"

      String.contains?(framework_name, ["gin", "echo", "fiber"]) ->
        "go"

      String.contains?(framework_name, ["actix", "rocket", "warp"]) ->
        "rust"

      String.contains?(framework_name, ["laravel", "symfony"]) ->
        "php"
  ...
  defp call_rust_architecture_engine(operation, request) do
    ...
    case operation do
      ...
      :collect_package ->
        Singularity.ArchitectureEngine.collect_package(
  ...
  defp detect_framework_from_pattern(pattern, context) do
    ...
    cond do
      ...
      String.contains?(pattern_lower, "phoenix") or String.contains?(context_lower, "phoenix") or
        String.contains?(pattern_lower, "phoenix.router") or
        String.contains?(pattern_lower, "phoenix.controller") or
        String.contains?(pattern_lower, "phoenix.view") or
        String.contains?(pattern_lower, "phoenix.template") or
        String.contains?(pattern_lower, "phoenix.channel") or
          String.contains?(pattern_lower, "phoenix.socket") ->
        [
          %{
            name: "phoenix",
            version: "1.7.0",
      ...
      String.contains?(pattern_lower, "ecto") or String.contains?(context_lower, "ecto") or
        String.contains?(pattern_lower, "ecto.schema") or
        String.contains?(pattern_lower, "ecto.changeset") or
        String.contains?(pattern_lower, "ecto.query") or
          String.contains?(pattern_lower, "ecto.repo") ->
        [
          %{
            name: "ecto",
            version: "3.10.0",
      ...
      String.contains?(pattern_lower, "nats") or String.contains?(context_lower, "nats") or
        String.contains?(pattern_lower, "gnat") or
          String.contains?(pattern_lower, "nats.connection") ->
        [
          %{
            name: "nats",
            version: "0.1.0",
      ...
      # PostgreSQL patterns
      String.contains?(pattern_lower, "postgresql") or
        String.contains?(context_lower, "postgresql") or
      ...
      String.contains?(pattern_lower, "react") or String.contains?(context_lower, "react") or
        String.contains?(pattern_lower, "react.component") or
        String.contains?(pattern_lower, "jsx") or
      ...
      String.contains?(pattern_lower, "express") or String.contains?(context_lower, "express") or
        String.contains?(pattern_lower, "express.router") or
          String.contains?(pattern_lower, "express.app") ->
        [
          %{
            name: "express",
            version: "4.18.0",
      ...
      String.contains?(pattern_lower, "django") or String.contains?(context_lower, "django") or
        String.contains?(pattern_lower, "django.views") or
        String.contains?(pattern_lower, "django.models") or
      ...
      String.contains?(pattern_lower, "flask") or String.contains?(context_lower, "flask") or
        String.contains?(pattern_lower, "flask.app") or
          String.contains?(pattern_lower, "flask.route") ->
        [
          %{
            name: "flask",
            version: "2.3.0",
      ...
      String.contains?(pattern_lower, "rails") or String.contains?(context_lower, "rails") or
        String.contains?(pattern_lower, "rails.controller") or
        String.contains?(pattern_lower, "rails.model") or
      ...
      String.contains?(pattern_lower, "spring") or String.contains?(context_lower, "spring") or
        String.contains?(pattern_lower, "springboot") or
          String.contains?(pattern_lower, "@springbootapplication") ->
        [
          %{
            name: "spring-boot",
            version: "3.0.0",
      ...
      String.contains?(pattern_lower, "asp.net") or String.contains?(context_lower, "asp.net") or
        String.contains?(pattern_lower, "microsoft.aspnetcore") or
          String.contains?(pattern_lower, "entityframework") ->
        [
          %{
            name: "asp.net-core",
            version: "7.0.0",
      ...
      String.contains?(pattern_lower, "gin") or String.contains?(context_lower, "gin") or
        String.contains?(pattern_lower, "gin.router") or
          String.contains?(pattern_lower, "gin.context") ->
        [
          %{
            name: "gin",
            version: "1.9.0",
      ...
      String.contains?(pattern_lower, "actix") or String.contains?(context_lower, "actix") or
        String.contains?(pattern_lower, "actix_web") or
          String.contains?(pattern_lower, "actix::web") ->
        [
          %{
            name: "actix-web",
            version: "4.3.0",
  ...
  defp detect_technology_from_pattern(pattern) do
    ...
    cond do
      ...
      String.contains?(pattern_lower, ".py") or String.contains?(pattern_lower, "def ") or
        ...
        String.contains?(pattern_lower, "from ") or
          String.contains?(pattern_lower, "requirements.txt") ->
        [
          %{
            name: "python",
            version: "3.11.0",
      ...
      String.contains?(pattern_lower, ".java") or String.contains?(pattern_lower, "public class ") or
        String.contains?(pattern_lower, "import java.") or
          String.contains?(pattern_lower, "package ") ->
        [
          %{
            name: "java",
            version: "17.0.0",
      ...
      String.contains?(pattern_lower, ".cs") or String.contains?(pattern_lower, "using ") or
        String.contains?(pattern_lower, "namespace ") or
          String.contains?(pattern_lower, "public class ") ->
        [
          %{
            name: "csharp",
            version: "11.0.0",
      ...
      String.contains?(pattern_lower, ".sql") or String.contains?(pattern_lower, "create table") or
        String.contains?(pattern_lower, "select ") or
          String.contains?(pattern_lower, "insert into") ->
        [
          %{
            name: "sql",
            version: "standard",
  ...
  defp mock_architectural_suggestions(request) do
    ...
    multi_lang_suggestions =
      if has_multiple_languages do
        [
          %{
            type: "architecture",
            category: "polyglot",
            ...
            priority: "high",
            reasoning:
              "Multiple languages detected - consider API Gateway for unified communication",
            confidence: 0.85
          },
          %{
            type: "architecture",
    ...
    fullstack_suggestions =
      if has_frontend and has_backend do
        [
          %{
            type: "architecture",
            category: "fullstack",
  ...
  defp query_centralcloud_for_framework(framework_name) do
    ...
    try do
      ...
      case Singularity.NatsOrchestrator.request("framework.pattern.query", request,
             timeout: 15_000
           ) do
        {:ok, response} ->
          case response do
        ...
        {:error, reason} ->
          Logger.warning("Failed to query CentralCloud for #{framework_name}",
