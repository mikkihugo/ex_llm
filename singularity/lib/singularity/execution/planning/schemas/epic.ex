defmodule Singularity.Execution.Planning.Schemas.Epic do
  @moduledoc """
  ...
  - `Singularity.Execution.Planning.Schemas.StrategicTheme` - Theme relationships (belongs_to :theme)
  - `Singularity.Execution.Planning.Schemas.Capability` - Capability relationships (has_many :capabilities)
  ...
  alias Singularity.Execution.Planning.Schemas.{StrategicTheme, Capability}
