defmodule Singularity.Execution.Planning.Schemas.StrategicTheme do
  @moduledoc """
  ...
  - `Singularity.Execution.Planning.Schemas.Epic` - Epic relationships (has_many :epics)
  ...
  alias Singularity.Execution.Planning.Schemas.Epic
