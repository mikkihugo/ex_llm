...
describe('IdeClient', () => {
    ...
    describe('getConnectionConfigFromFile', () => {
        ...
        it('should filter out configs with invalid workspace paths', async () => {
            ...
            expect(validateSpy).toHaveBeenCalledWith('/invalid/workspace', 'VS Code', '/test/workspace/sub-dir');
            expect(validateSpy).toHaveBeenCalledWith('/test/workspace', 'VS Code', '/test/workspace/sub-dir');
        });
