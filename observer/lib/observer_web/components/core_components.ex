defmodule ObserverWeb.CoreComponents do
  @moduledoc """
  ...
  Icons are provided by the [heroicons](https://hex.pm/packages/heroicons) package and rendered
  ...
  def translate_error({msg, opts}) do
    ...
    if count = opts[:count] do
      Gettext.dngettext(ObserverWeb.Gettext, "errors", msg, msg, count, opts)
    else
      Gettext.dgettext(ObserverWeb.Gettext, "errors", msg, opts)
    end
  end
