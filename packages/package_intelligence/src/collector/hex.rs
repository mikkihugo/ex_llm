...
use super::{
  CollectionStats as SuperCollectionStats,
  DataSourcePriority as SuperDataSourcePriority, PackageCollector,
};
...
impl HexCollector {
  ...
  async fn download_package(
    ...
    let tarball_url =
      format!("https://repo.hex.pm/tarballs/{}-{}.tar", package, version);
