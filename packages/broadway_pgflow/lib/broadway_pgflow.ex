defmodule Broadway.Pgflow do
  @version "0.1.0"

  @moduledoc """
  Broadway.Pgflow is a Broadway-compatible producer adapter backed by PGFlow workflows.
 
  Overview
 
  Provides durable, orchestrated message production using PostgreSQL-backed PGFlow workflows.
  ...
  Configure PGFlow and repo in your application config; see README for details.
