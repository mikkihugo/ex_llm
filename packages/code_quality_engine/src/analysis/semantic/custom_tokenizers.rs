...
impl CodeTokenizer {
    ...
    fn tokenize_rust(&self, content: &str) -> Result<Vec<DataToken>> {
        ...
        self.tokenize_with_keywords(
            content,
            &[
                "fn", "struct", "enum", "trait", "impl", "pub", "async", "await", "mod", "use",
                "let", "mut", "const", "static", "type", "if", "else", "for", "while", "loop",
                "match", "return", "yield", "break", "continue",
            ],
        )
    }
    ...
    fn tokenize_python(&self, content: &str) -> Result<Vec<DataToken>> {
        ...
        self.tokenize_with_keywords(
            content,
            &[
                "def", "class", "async", "await", "import", "from", "if", "elif", "else", "for",
                "while", "with", "try", "except", "finally", "return", "yield", "break",
                "continue", "pass", "lambda", "global", "nonlocal",
            ],
        )
    }
