...
fn calculate_complexity(tokens: &[crate::analysis::semantic::custom_tokenizers::DataToken]) -> f64 {
    ...
    for token in tokens {
        match token.token_type {
            ...
            crate::analysis::semantic::custom_tokenizers::TokenType::FunctionName => {
                function_count += 1
            }
    ...
    let complexity =
        (keyword_count as f64 + (function_count as f64 * 2.0) + (class_count as f64 * 3.0))
            / tokens.len() as f64;
...
fn calculate_quality(
    tokens: &[crate::analysis::semantic::custom_tokenizers::DataToken],
    total_lines: usize,
) -> f64 {
