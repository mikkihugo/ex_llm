defmodule Pgflow.Orchestrator.Repository do
  @moduledoc """
  ...
  """
  @spec create_task_graph(map(), Ecto.Repo.t()) :: {:ok, Schemas.TaskGraph.t()} | {:error, Ecto.Changeset.t()}
  ...
  """
  @spec get_task_graph(binary(), Ecto.Repo.t()) :: {:ok, Schemas.TaskGraph.t()} | {:error, :not_found}
  ...
  - `{:error, changeset}` - Validation failed
  """
  @spec create_workflow(map(), Ecto.Repo.t()) :: {:ok, Schemas.Workflow.t()} | {:error, Ecto.Changeset.t()}
  ...
  """
  @spec get_workflows_by_name(String.t(), Ecto.Repo.t(), keyword()) :: {:ok, list(Schemas.Workflow.t())} | {:error, any()}
  def get_workflows_by_name(name_pattern, repo, opts \\ []) do
    limit = Keyword.get(opts, :limit, 50)
    offset = Keyword.get(opts, :offset, 0)
    
    query = from w in Schemas.Workflow,
  ...
  - `{:error, changeset}` - Validation failed
  """
  @spec create_execution(map(), Ecto.Repo.t()) :: {:ok, Schemas.Execution.t()} | {:error, Ecto.Changeset.t()}
  ...
  """
  @spec get_execution(binary(), Ecto.Repo.t()) :: {:ok, Schemas.Execution.t()} | {:error, :not_found}
  ...
  - `{:error, changeset}` - Validation failed
  """
  @spec create_task_execution(map(), Ecto.Repo.t()) :: {:ok, Schemas.TaskExecution.t()} | {:error, Ecto.Changeset.t()}
  ...
  - `{:error, changeset}` - Update failed
  """
  @spec update_task_execution_status(Schemas.TaskExecution.t(), String.t(), Ecto.Repo.t(), keyword()) :: 
  ...
  - `{:error, changeset}` - Validation failed
  """
  @spec create_event(map(), Ecto.Repo.t()) :: {:ok, Schemas.Event.t()} | {:error, Ecto.Changeset.t()}
  ...
  - `{:error, reason}` - Query failed
  """
  @spec get_recent_events(binary(), Ecto.Repo.t(), keyword()) :: {:ok, list(Schemas.Event.t())} | {:error, any()}
  def get_recent_events(execution_id, repo, opts \\ []) do
    limit = Keyword.get(opts, :limit, 100)
    event_types = Keyword.get(opts, :event_types, [])
    
    query = from e in Schemas.Event,
  ...
  - `{:error, changeset}` - Validation failed
  """
  @spec create_performance_metric(map(), Ecto.Repo.t()) :: {:ok, Schemas.PerformanceMetric.t()} | {:error, Ecto.Changeset.t()}
  ...
  - `{:error, reason}` - Query failed
  """
  @spec get_performance_metrics(binary(), Ecto.Repo.t(), keyword()) :: {:ok, list(Schemas.PerformanceMetric.t())} | {:error, any()}
  def get_performance_metrics(workflow_id, repo, opts \\ []) do
    metric_type = Keyword.get(opts, :metric_type)
    since = Keyword.get(opts, :since)
    limit = Keyword.get(opts, :limit, 1000)
    
    query = from m in Schemas.PerformanceMetric,
      where: m.workflow_id == ^workflow_id,
      limit: ^limit,
      order_by: [desc: m.timestamp]
    
    query = if metric_type do
  ...
  - `{:error, changeset}` - Validation failed
  """
  @spec create_learning_pattern(map(), Ecto.Repo.t()) :: {:ok, Schemas.LearningPattern.t()} | {:error, Ecto.Changeset.t()}
  ...
  - `{:error, reason}` - Query failed
  """
  @spec get_learning_patterns(String.t(), Ecto.Repo.t(), keyword()) :: {:ok, list(Schemas.LearningPattern.t())} | {:error, any()}
  def get_learning_patterns(workflow_name, repo, opts \\ []) do
    ...
    query = from p in Schemas.LearningPattern,
  ...
  def get_execution_stats(repo, opts \\ []) do
    ...
    case repo.aggregate(query, :count, :id) do
      total_executions when is_integer(total_executions) ->
        ...
        avg_duration_query = from e in query, 
