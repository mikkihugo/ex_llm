...
# - Pure OTP backend services (Singularity, Genesis, CentralCloud, Nexus)
#
...
# 4. nexus - LLM router and HITL bridge (pure OTP)
...
# Pure OTP application - routes LLM requests via ex_llm
nexus: cd nexus && iex -S mix
