defmodule Singularity.Repo.Migrations.CreateSettingsTable do
  ...
  def change do
    ...
    ('pipelines.code_quality.enabled', '{"type": "boolean", "value": false}', 'Enable PGFlow mode for code quality training pipeline', 'pipelines', 'migration', NOW()),
    ('pipelines.complexity_training.enabled', '{"type": "boolean", "value": false}', 'Enable PGFlow mode for complexity analysis training pipeline', 'pipelines', 'migration', NOW()),
    ('pipelines.architecture_learning.enabled', '{"type": "boolean", "value": false}', 'Enable PGFlow mode for architecture learning pipeline', 'pipelines', 'migration', NOW()),
    ('pipelines.embedding_training.enabled', '{"type": "boolean", "value": false}', 'Enable PGFlow mode for embedding training pipeline', 'pipelines', 'migration', NOW()),
