defmodule Singularity.Infrastructure.Telemetry do
  ...
  @impl true
  def init(_arg) do
    # Attach Metrics.Aggregator handler for unified metrics collection
  ...
  defp attach_metrics_handlers do
    # Attach Aggregator to handle telemetry events
    ...
    :telemetry.attach_many(
      ...
      &Singularity.Metrics.Aggregator.handle_telemetry_event/4,
      nil
    )
  end
