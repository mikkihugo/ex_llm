defmodule Singularity.Infrastructure.HealthAgent do
  ...
  Responsibilities:
    ...
    * Monitor service health and performance metrics gathered from the codebase registry
    * Detect failures/anomalies and produce structured reports
    * Provide restart and validation helpers that other infrastructure modules can call
    * Generate dashboards/alerts for the observability stack
  """
