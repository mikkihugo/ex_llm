defmodule Singularity.Infrastructure.EricssonSasl.Mechanism do
  @moduledoc """
  Base module for Ericsson SASL mechanism implementations.

  This module defines the behavior that all Ericsson SASL mechanisms must implement,
  providing a consistent interface for different authentication protocols used in
  Ericsson telecommunications systems.
  """

  alias Singularity.Infrastructure.EricssonSasl.Security
