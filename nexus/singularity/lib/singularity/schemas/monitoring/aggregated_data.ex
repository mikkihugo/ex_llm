defmodule Singularity.Metrics.AggregatedData do
  ...
  ```json
  {
    ...
    "features": ["time_bucketing", "statistics", "idempotent_aggregation"]
  }
  ```

  ### Anti-Patterns
  - ❌ DO NOT use Metrics.Event for aggregated data - use this schema
  - ❌ DO NOT store raw events here - use Metrics.Event instead
  - ✅ DO use this for pre-computed hourly/daily statistics
  - ✅ DO rely on unique constraint for idempotent aggregation

  ### Search Keywords
  metrics aggregation, time series, statistics, hourly rollup, daily rollup,
  pre-computed stats, event summarization, performance metrics, monitoring
