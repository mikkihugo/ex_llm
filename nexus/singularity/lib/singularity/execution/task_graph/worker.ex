defmodule Singularity.Execution.TaskGraph.Worker do
  @moduledoc """
  TaskGraph.Worker - Individual worker that executes a single todo.
  ...
  Workers are typically spawned by TaskGraph.WorkerPool:

  ```elixir
  {:ok, pid} = TaskGraph.Worker.start_link(
    todo_id: "uuid-here",
  ...
  def init(opts) do
    ...
    Logger.info("TaskGraph.Worker started",
      worker_id: worker_id,
      todo_id: todo_id
    )
