defmodule CentralCloud.Repo.Migrations.CreateQuantumFlowBroadwayQueues do
  use Ecto.Migration

  @tables [
    :central_complexity_training_jobs,
    :central_pattern_learning_jobs,
    :central_model_ingestion_jobs
  ]
