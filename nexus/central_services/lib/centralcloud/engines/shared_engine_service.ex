defmodule CentralCloud.Engines.SharedEngineService do
  ...
  def call_architecture_engine(operation, request, opts \\ []) do
    ...
    case QuantumFlow.Notifications.send_with_notify("engines.architecture.#{operation}", request, CentralCloud.Repo) do
      {:ok, response} ->
  ...
  def call_code_quality_engine(operation, request, opts \\ []) do
    ...
    case QuantumFlow.Notifications.send_with_notify("engines.code.#{operation}", request, CentralCloud.Repo) do
      {:ok, response} ->
  ...
  def call_linting_engine(operation, request, opts \\ []) do
    ...
    case QuantumFlow.Notifications.send_with_notify("engines.linting.#{operation}", request, CentralCloud.Repo) do
      {:ok, response} ->
  ...
  def call_embedding_engine(operation, request, opts \\ []) do
    ...
    case QuantumFlow.Notifications.send_with_notify("engines.embedding.#{operation}", request, CentralCloud.Repo) do
      {:ok, response} ->
  ...
  def call_parser_engine(operation, request, opts \\ []) do
    ...
    case QuantumFlow.Notifications.send_with_notify("engines.parser.#{operation}", request, CentralCloud.Repo) do
      {:ok, response} ->
  ...
  def call_prompt_engine(operation, request, opts \\ []) do
    ...
    case QuantumFlow.Notifications.send_with_notify("engines.prompt.#{operation}", request, CentralCloud.Repo) do
      {:ok, response} ->
  ...
  def get_engine_health do
    ...
    health_checks = Enum.map(engines, fn engine ->
      case QuantumFlow.Notifications.send_with_notify("engines.#{engine}.health", %{}, CentralCloud.Repo) do
