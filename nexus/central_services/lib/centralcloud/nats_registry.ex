defmodule CentralCloud.NatsRegistry do
  @moduledoc """
  Compatibility registry that maps legacy NATS subjects to their QuantumFlow queue
  equivalents.

  The CentralCloud codebase historically routed request/response style
  interactions through NATS subjects such as `llm.request`.  QuantumFlow replaces
