...
# Broadcast via quantum_flow: "evolution_voting_requests"
...
case ConsensusEngine.vote_on_change("dev-2", change_id, vote, reason) do
  ...
  {:ok, :consensus_reached} ->
    ...
    # Change is broadcast to all instances via quantum_flow
...
# Listen to quantum_flow queue: "evolution_approved_changes"
...
## quantum_flow Queue Integration
...
3. **Configure quantum_flow queues**: Set up queue listeners
