defmodule CentralCloud.Database.MessageQueue do
  @moduledoc """
  PostgreSQL-based message queue for CentralCloud using pgmq extension.

  Provides durable, ACID-backed messaging for:
  - Pattern synchronization from multiple Singularity instances
  - Knowledge base updates
  - Inter-instance communication
  - Aggregation job notifications

  ## Queues

  - `cc-instance-patterns` - Patterns from Singularity instances
  - `cc-knowledge-updates` - Knowledge base sync requests
  - `cc-aggregation-jobs` - Cross-instance aggregation tasks
  - `cc-metrics-reports` - Metrics and statistics from instances
