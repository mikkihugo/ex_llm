defmodule CentralCloud.Database.Encryption do
  @moduledoc """
  Database-level encryption for CentralCloud using PostgreSQL pgsodium extension.

  Provides modern cryptography (XSalsa20-Poly1305, Argon2) at the database layer
  for aggregated patterns, knowledge base entries, and inter-instance communication.
  ...
  ## Use Cases
  - Encrypt aggregated pattern data from Singularity instances
  - Secure API keys for instance communication
  - Encrypt sensitive metadata in knowledge base
  """
  ...
  @doc """
  Encrypt sensitive knowledge base data.
  """
  ...
  @doc """
  Hash a password or API key using Argon2 (memory-hard algorithm).
  """
  ...
  @doc """
  Generate a cryptographically secure random token for API keys or instance tokens.
  """
  ...
  @doc """
  Sign a message (HMAC for message authentication between instances).
  """
  ...
  @doc """
  Verify a signed message from a Singularity instance.
  """
