defmodule ExLLM.Providers.Jules do
  @moduledoc """
  Google Jules Provider for ExLLM.
  ...
  For long-running code generation tasks using the async request-reply pattern.
      ...
      iex> {:ok, session_id} = ExLLM.Providers.Jules.create_session(
      ...>   prompt: "Add dark mode support to the dashboard"
      ...> )
      iex> {:ok, session} = ExLLM.Providers.Jules.poll_session(session_id)
  ...
  ## Example: Full Workflow
      ...
      iex> alias ExLLM.Providers.Jules
  ...
  require Logger
  alias ExLLM.Providers.Jules.TaskClient
  alias ExLLM.Providers.Jules.ResponseExtractor
  alias ExLLM.Types
