defmodule ExLLM.Providers.GitHubModels do
  @moduledoc """
  GitHub Models Provider for ExLLM.
  ...
  ## Usage
      ...
      iex> ExLLM.Providers.GitHubModels.chat([
      ...>   %{role: "user", content: "Hello from GitHub Models!"}
      ...> ])
      {:ok, %ExLLM.Types.LLMResponse{content: "Hello! How can I help you today?"}}
