defmodule ExLLM.Routing.TaskMetrics do
  @moduledoc """
  ...
  def estimate_from_semantic_similarity(_task_type, _model_name, complexity_level \\ :medium) do
    ...
    #
    # Example:
    # task_embedding = ExLLM.Embeddings.embed(":#{task_type} task")
  ...
  defp query_task_metrics_from_db(task_type, model_name, complexity_level) do
    ...
    try do
      # Try to get CentralCloud repo - it may not be available if ExLLM is standalone
