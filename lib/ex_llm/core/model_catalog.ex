defmodule ExLLM.Core.ModelCatalog do
  @moduledoc """
  ...
  Return: %Model{provider: :github_models, name: "gpt-4o", complexity_scores: ...}
      ↓
  ExLLM.chat(model_name, messages)  # Route to provider via unified API
  ```
  ...
  DO NOT:
  - Request models directly from providers (`ExLLM.Providers.GitHub.chat/2`)
