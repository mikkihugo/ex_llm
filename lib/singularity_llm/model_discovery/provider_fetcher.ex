defmodule SingularityLLM.ModelDiscovery.ProviderFetcher do
  @moduledoc """
  ...
  require Logger
  alias SingularityLLM.ModelDiscovery.ProviderAdapters
  ...
  defp adapter_for(provider) do
    # Provider adapters implement SingularityLLM.ModelDiscovery.ProviderAdapter behavior
