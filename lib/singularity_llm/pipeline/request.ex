defmodule SingularityLLM.Pipeline.Request do
  @moduledoc """
  ...
  ## Fields
    ...
    * `:result` - Parsed result in SingularityLLM format
  ...
  ## Examples
      ...
      iex> request = SingularityLLM.Pipeline.Request.new(:openai, [%{role: "user", content: "Hello"}])
  ...
  ## Examples
      ...
      iex> request = SingularityLLM.Pipeline.Request.new(:openai, [])
      iex> halted_request = SingularityLLM.Pipeline.Request.halt(request)
  ...
  ## Examples
      ...
      iex> request = SingularityLLM.Pipeline.Request.new(:openai, [])
      iex> request = SingularityLLM.Pipeline.Request.assign(request, :auth_token, "secret")
  ...
  ## Examples
      ...
      iex> request = SingularityLLM.Pipeline.Request.new(:openai, [])
      iex> request = SingularityLLM.Pipeline.Request.assign(request, auth: "token", model: "gpt-4")
      iex> request.assigns
  ...
  ## Examples
      ...
      iex> request = SingularityLLM.Pipeline.Request.new(:openai, [])
      iex> request = SingularityLLM.Pipeline.Request.put_private(request, :internal_flag, true)
  ...
  ## Examples
      ...
      iex> request = SingularityLLM.Pipeline.Request.new(:openai, [])
      iex> request = SingularityLLM.Pipeline.Request.put_state(request, :executing)
      iex> request.state
      :executing
  """
  ...
  ## Examples
      ...
      iex> request = SingularityLLM.Pipeline.Request.add_error(request, error)
  ...
  ## Examples
      ...
      iex> request = SingularityLLM.Pipeline.Request.halt_with_error(request, error)
      iex> request.halted
      true
      iex> length(request.errors)
      1
  ...
  ## Examples
      ...
      iex> request = SingularityLLM.Pipeline.Request.new(:openai, [])
      iex> request = SingularityLLM.Pipeline.Request.put_metadata(request, :tokens, 100)
  ...
  ## Examples
      ...
      iex> request = SingularityLLM.Pipeline.Request.new(:openai, [])
      iex> request = SingularityLLM.Pipeline.Request.merge_metadata(request, %{tokens: 100, cost: 0.02})
