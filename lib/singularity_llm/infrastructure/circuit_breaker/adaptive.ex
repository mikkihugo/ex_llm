defmodule SingularityLLM.Infrastructure.CircuitBreaker.Adaptive do
  @moduledoc """
  ...
  defp build_config(opts) do
    ...
    app_config = Application.get_env(:singularity_llm, :circuit_breaker, %{})
  ...
  defp update_circuit_threshold(circuit_name, circuit_state, config) do
    ...
    telemetry_metrics = SingularityLLM.Infrastructure.CircuitBreaker.Telemetry.get_metrics(circuit_name)
    ...
    if telemetry_metrics.total_calls >= config.min_calls_for_adaptation do
      ...
      if new_threshold != current_threshold do
        ...
        SingularityLLM.Infrastructure.CircuitBreaker.update_config(circuit_name,
  ...
  defp get_default_threshold do
    Application.get_env(:singularity_llm, :circuit_breaker, %{})
