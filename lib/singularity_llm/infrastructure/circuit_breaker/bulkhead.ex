defmodule SingularityLLM.Infrastructure.CircuitBreaker.Bulkhead do
  @moduledoc """
  ...
  ## Usage
      ...
      SingularityLLM.Infrastructure.CircuitBreaker.Bulkhead.configure("api_circuit",
        max_concurrent: 5,
        max_queued: 20,
        queue_timeout: 3000
      )
      ...
      SingularityLLM.Infrastructure.CircuitBreaker.call_with_bulkhead("api_circuit", fn ->
        # Your API call here
        HTTP.Core.get("/api/data")
      end)
  """

  alias SingularityLLM.Infrastructure.CircuitBreaker.BulkheadWorker
