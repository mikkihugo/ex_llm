defmodule SingularityLLM.Infrastructure.CircuitBreaker.Telemetry do
  @moduledoc """
  ...
  @events [
    ...
    [:singularity_llm, :circuit_breaker, :circuit_created],
    [:singularity_llm, :circuit_breaker, :state_change],

    # Call events
    [:singularity_llm, :circuit_breaker, :call_success],
    [:singularity_llm, :circuit_breaker, :call_failure],
    [:singularity_llm, :circuit_breaker, :call_timeout],
    [:singularity_llm, :circuit_breaker, :call_rejected],

    # Failure tracking
    [:singularity_llm, :circuit_breaker, :failure_recorded],
    [:singularity_llm, :circuit_breaker, :success_recorded],

    # Configuration events
    [:singularity_llm, :circuit_breaker, :config_updated],
    [:singularity_llm, :circuit_breaker, :circuit_reset],

    # Health check events
    [:singularity_llm, :circuit_breaker, :health_check],
    [:singularity_llm, :circuit_breaker, :health_check, :completed],

    # Adaptive threshold events
    [:singularity_llm, :circuit_breaker, :threshold_update],

    # Bulkhead events  
    [:singularity_llm, :circuit_breaker, :bulkhead, :metrics_updated],
    [:singularity_llm, :circuit_breaker, :bulkhead, :request_accepted],
    [:singularity_llm, :circuit_breaker, :bulkhead, :request_rejected],
    [:singularity_llm, :circuit_breaker, :bulkhead, :request_queued],

    # Configuration manager events
    [:singularity_llm, :circuit_breaker, :config_manager, :config_updated],
    [:singularity_llm, :circuit_breaker, :config_manager, :profile_applied],
    [:singularity_llm, :circuit_breaker, :config_manager, :config_rollback],
    [:singularity_llm, :circuit_breaker, :config_manager, :config_reset]
  ]
