defmodule SingularityLLM.Infrastructure.CircuitBreaker.Metrics.PrometheusEndpoint do
  @moduledoc """
  ...
  ## Phoenix Integration
      ...
      defmodule MyAppWeb.Router do
        ...
        scope "/metrics" do
          ...
          get "/circuit_breakers", SingularityLLM.CircuitBreaker.Metrics.PrometheusEndpoint, :metrics
        end
      end
  ...
  ## Standalone Usage
      ...
      SingularityLLM.CircuitBreaker.Metrics.PrometheusEndpoint.start_server(port: 9090)

  ## Manual Export

      # Get metrics as text
      {:ok, metrics_text} = SingularityLLM.CircuitBreaker.Metrics.PrometheusEndpoint.export()
  """
  ...
  """
  def export do
    SingularityLLM.Infrastructure.CircuitBreaker.Metrics.export_prometheus()
  end
