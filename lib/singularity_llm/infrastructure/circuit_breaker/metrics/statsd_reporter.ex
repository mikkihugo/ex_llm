defmodule SingularityLLM.Infrastructure.CircuitBreaker.Metrics.StatsDReporter do
  @moduledoc """
  ...
  ## Configuration
      ...
      config :singularity_llm, :circuit_breaker_metrics,
        statsd: [
          ...
          tags: ["service:singularity_llm", "version:1.0.0"],
          sample_rate: 1.0,
          batch_size: 10,
          flush_interval: 1000
        ]
  ...
  ## Usage
      ...
      # Start reporter
      SingularityLLM.CircuitBreaker.Metrics.StatsDReporter.start_link()
      
      # Report metrics
      SingularityLLM.CircuitBreaker.Metrics.StatsDReporter.counter("requests.total", 1, 
        tags: ["circuit:api_service", "result:success"])
      
      # Report with sampling
      SingularityLLM.CircuitBreaker.Metrics.StatsDReporter.gauge("health.score", 85,
