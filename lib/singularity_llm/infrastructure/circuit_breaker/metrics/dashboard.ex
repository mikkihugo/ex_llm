defmodule SingularityLLM.Infrastructure.CircuitBreaker.Metrics.Dashboard do
  @moduledoc """
  ...
  ## Usage
      ...
      # Get dashboard data
      {:ok, dashboard_data} = SingularityLLM.Infrastructure.CircuitBreaker.Metrics.Dashboard.get_dashboard_data()
      
      # Get specific widget data
      {:ok, health_data} = SingularityLLM.Infrastructure.CircuitBreaker.Metrics.Dashboard.health_widget()
      {:ok, throughput_data} = SingularityLLM.Infrastructure.CircuitBreaker.Metrics.Dashboard.throughput_widget()
      
      # Export data
      {:ok, json} = SingularityLLM.Infrastructure.CircuitBreaker.Metrics.Dashboard.export_json()
      {:ok, csv} = SingularityLLM.Infrastructure.CircuitBreaker.Metrics.Dashboard.export_csv()
  """

  alias SingularityLLM.Infrastructure.CircuitBreaker
  alias SingularityLLM.Infrastructure.CircuitBreaker.HealthCheck
