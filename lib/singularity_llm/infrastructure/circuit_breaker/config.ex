defmodule SingularityLLM.Infrastructure.CircuitBreaker.Config do
  @moduledoc """
  ...
  def import_all(config_data) when is_map(config_data) do
    ...
    |> Enum.map(fn {circuit_name, circuit_config} ->
      ...
      SingularityLLM.Infrastructure.CircuitBreaker.call(circuit_name, fn -> :ok end, circuit_config)
