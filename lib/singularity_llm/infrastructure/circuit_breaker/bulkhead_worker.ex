defmodule SingularityLLM.Infrastructure.CircuitBreaker.BulkheadWorker do
  @moduledoc """
  ...
  def via_tuple(circuit_name) do
    {:via, Registry, {SingularityLLM.Infrastructure.CircuitBreaker.Bulkhead.Registry, circuit_name}}
  end
