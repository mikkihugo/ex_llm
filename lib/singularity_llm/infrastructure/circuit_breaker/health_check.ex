defmodule SingularityLLM.Infrastructure.CircuitBreaker.HealthCheck do
  @moduledoc """
  ...
  ## Usage
      ...
      SingularityLLM.Infrastructure.CircuitBreaker.HealthCheck.system_health()
      
      # Check specific circuit health
      SingularityLLM.Infrastructure.CircuitBreaker.HealthCheck.circuit_health("api_service")
      
      # Get health summary for all circuits
      SingularityLLM.Infrastructure.CircuitBreaker.HealthCheck.health_summary()
      
      # Get detailed health report
      SingularityLLM.Infrastructure.CircuitBreaker.HealthCheck.health_report()
  """

  alias SingularityLLM.Infrastructure.CircuitBreaker
  ...
  defp get_telemetry_metrics(circuit_name, time_window) do
    try do
      metrics = SingularityLLM.Infrastructure.CircuitBreaker.Telemetry.get_metrics(circuit_name)
  ...
  defp get_bulkhead_metrics(circuit_name) do
    try do
      ...
      if Process.whereis(SingularityLLM.Infrastructure.CircuitBreaker.Bulkhead.Registry) do
        metrics = SingularityLLM.Infrastructure.CircuitBreaker.Bulkhead.get_metrics(circuit_name)
