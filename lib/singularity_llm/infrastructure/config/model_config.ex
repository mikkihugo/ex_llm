defmodule SingularityLLM.Infrastructure.Config.ModelConfig do
  @moduledoc """
  Model configuration loader for SingularityLLM.
    ...
    if File.exists?(cwd_path) do
      ...
      if File.exists?(source_relative) do
        ...
        find_project_config_dir(File.cwd!()) ||
          :code.priv_dir(:singularity_llm) |> Path.join("../../config/models") |> Path.expand()
      end
    end
  end
  ...
  ## Examples
      ...
      iex> SingularityLLM.Infrastructure.Config.ModelConfig.get_pricing(:openai, "gpt-4o")
      %{input: 2.50, output: 10.00}

      iex> SingularityLLM.Infrastructure.Config.ModelConfig.get_pricing(:anthropic, "claude-3-5-sonnet-20241022")
      %{input: 3.00, output: 15.00}
      
      iex> SingularityLLM.Infrastructure.Config.ModelConfig.get_pricing(:ollama, "any-model")
      %{input: 0.0, output: 0.0}

      iex> SingularityLLM.Infrastructure.Config.ModelConfig.get_pricing(:unknown_provider, "model")
      nil
  """
  ...
  ## Examples
      ...
      iex> SingularityLLM.Infrastructure.Config.ModelConfig.get_context_window(:openai, "gpt-4o")
      128000

      iex> SingularityLLM.Infrastructure.Config.ModelConfig.get_context_window(:anthropic, "claude-3-5-sonnet-20241022")
      200000
      
      iex> SingularityLLM.Infrastructure.Config.ModelConfig.get_context_window(:ollama, "unknown-model")
      4096
  """
  ...
  ## Examples
      ...
      iex> SingularityLLM.Infrastructure.Config.ModelConfig.get_capabilities(:openai, "gpt-4o")
      [:text, :vision, :function_calling, :streaming]
      
      iex> SingularityLLM.Infrastructure.Config.ModelConfig.get_capabilities(:ollama, "unknown-model")
      [:chat, :streaming]
  """
  ...
  ## Examples
      ...
      iex> SingularityLLM.Infrastructure.Config.ModelConfig.get_max_output_tokens(:openai, "gpt-4o")
      16384
      
      iex> SingularityLLM.Infrastructure.Config.ModelConfig.get_max_output_tokens(:ollama, "unknown-model")
      4096
  """
  ...
  ## Examples
      ...
      iex> SingularityLLM.Infrastructure.Config.ModelConfig.get_default_model(:openai)
      {:ok, "gpt-4o-mini"}

      iex> SingularityLLM.Infrastructure.Config.ModelConfig.get_default_model(:anthropic)
      {:ok, "claude-sonnet-4-20250514"}

      iex> SingularityLLM.Infrastructure.Config.ModelConfig.get_default_model(:non_existent_provider)
  ...
  ## Examples
      ...
      iex> models = SingularityLLM.Infrastructure.Config.ModelConfig.get_all_models(:anthropic)
      iex> Map.keys(models)
  ...
  ## Examples
      ...
      iex> pricing = SingularityLLM.Infrastructure.Config.ModelConfig.get_all_pricing(:openai)
      iex> pricing["gpt-4o"]
      %{input: 2.50, output: 10.00}
  """
  ...
  ## Examples
      ...
      iex> contexts = SingularityLLM.Infrastructure.Config.ModelConfig.get_all_context_windows(:anthropic)
  ...
  ## Examples
      ...
      iex> SingularityLLM.Infrastructure.Config.ModelConfig.get_model_config(:openai, "gpt-4o")
      %{
  ...
  ## Examples
      ...
      iex> SingularityLLM.Infrastructure.Config.ModelConfig.get_model_config_with_defaults(:ollama, "unknown-model")
      %{
        context_window: 4096,
