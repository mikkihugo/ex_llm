defmodule SingularityLLM.Infrastructure.Config.ProviderCapabilities do
  @moduledoc """
  Provider-level capability tracking for SingularityLLM.
  ...
  ## Usage
      ...
      SingularityLLM.Infrastructure.Config.ProviderCapabilities.supports?(:openai, :embeddings)
      
      # Get all capabilities for a provider
      {:ok, caps} = SingularityLLM.Infrastructure.Config.ProviderCapabilities.get_capabilities(:anthropic)
      
      # Find providers that support specific features
      providers = SingularityLLM.Infrastructure.Config.ProviderCapabilities.find_providers_with_features([:embeddings, :streaming])
      
      # Get provider recommendations based on requirements
      recommended = SingularityLLM.Infrastructure.Config.ProviderCapabilities.recommend_providers(%{
  ...
  ## Examples
      ...
      {:ok, info} = SingularityLLM.Infrastructure.Config.ProviderCapabilities.get_capabilities(:openai)
  """
  ...
  ## Examples
      ...
      SingularityLLM.Infrastructure.Config.ProviderCapabilities.supports?(:ollama, :cost_tracking)
      # => false
  """
  ...
  ## Examples
      ...
      SingularityLLM.Infrastructure.Config.ProviderCapabilities.get_auth_methods(:openai)
  ...
  ## Examples
      ...
      SingularityLLM.Infrastructure.Config.ProviderCapabilities.get_endpoints(:openai)
      # => [:chat, :embeddings, :images, :audio, :completions, :fine_tuning, :files]
  """
  ...
  ## Examples
      ...
      SingularityLLM.Infrastructure.Config.ProviderCapabilities.list_providers()
  ...
  ## Examples
      ...
      SingularityLLM.Infrastructure.Config.ProviderCapabilities.get_limitations(:ollama)
  ...
  ## Examples
      ...
      comparison = SingularityLLM.Infrastructure.Config.ProviderCapabilities.compare_providers([:openai, :anthropic, :ollama])
  """
  ...
  ## Examples
      ...
      recommendations = SingularityLLM.Infrastructure.Config.ProviderCapabilities.recommend_providers(%{
        required_features: [:streaming, :function_calling],
        preferred_features: [:vision, :cost_tracking],
        exclude_providers: [:mock]
      })
  ...
  ## Examples
      ...
      SingularityLLM.Infrastructure.Config.ProviderCapabilities.get_adapter_module(:openai)
      # => SingularityLLM.Providers.OpenAI
  """
  ...
  def get_adapter_module(provider) do
    case provider do
      ...
      :github_models -> SingularityLLM.Providers.GitHubModels
      _ -> nil
    end
  end
  ...
  ## Examples
      ...
      SingularityLLM.Infrastructure.Config.ProviderCapabilities.is_local?(:ollama)
      # => true
      
      SingularityLLM.Infrastructure.Config.ProviderCapabilities.is_local?(:openai)
      # => false
  """
  ...
  ## Examples
      ...
      SingularityLLM.Infrastructure.Config.ProviderCapabilities.requires_auth?(:openai)
      # => true
      
      SingularityLLM.Infrastructure.Config.ProviderCapabilities.requires_auth?(:ollama)
      # => false
  """
