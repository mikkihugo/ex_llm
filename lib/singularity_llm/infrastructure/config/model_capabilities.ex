defmodule SingularityLLM.Infrastructure.Config.ModelCapabilities do
  @moduledoc """
  Model capability discovery and management for SingularityLLM.
  ...
  ## Usage
      ...
      {:ok, caps} = SingularityLLM.Infrastructure.Config.ModelCapabilities.get_capabilities(:openai, "gpt-4-turbo")
      
      # Check if a model supports a specific feature
      SingularityLLM.Infrastructure.Config.ModelCapabilities.supports?(:anthropic, "claude-3-opus-20240229", :vision)
      
      # Find models that support specific features
      models = SingularityLLM.Infrastructure.Config.ModelCapabilities.find_models_with_features([:function_calling, :streaming])
      
      # Compare models
      comparison = SingularityLLM.Infrastructure.Config.ModelCapabilities.compare_models([
        {:openai, "gpt-4"},
  ...
  defp model_capabilities do
    ...
    dynamic_capabilities =
      ...
      |> Enum.flat_map(fn provider ->
        models = SingularityLLM.Infrastructure.Config.ModelConfig.get_all_models(provider)
  ...
  ## Examples
      ...
      {:ok, info} = SingularityLLM.Infrastructure.Config.ModelCapabilities.get_model_info(:openai, "gpt-4o")
  """
