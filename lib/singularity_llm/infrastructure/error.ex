defmodule SingularityLLM.Infrastructure.Error do
  @moduledoc """
  Standardized error types and utilities for SingularityLLM.

  This module defines consistent error patterns used throughout SingularityLLM
