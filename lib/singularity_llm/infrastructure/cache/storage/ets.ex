defmodule SingularityLLM.Infrastructure.Cache.Storage.ETS do
  @moduledoc """
  ETS-based storage backend for SingularityLLM cache.

  Provides fast in-memory caching with automatic expiration.
  """

  @behaviour SingularityLLM.Infrastructure.Cache.Storage
