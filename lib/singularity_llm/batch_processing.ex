defmodule SingularityLLM.BatchProcessing do
  @moduledoc """
  Batch processing functionality for SingularityLLM.
  ...
  ## Examples
      ...
      # Submit the batch
      {:ok, batch} = SingularityLLM.BatchProcessing.create_batch(:anthropic, requests)
      
      # Monitor progress
      {:ok, updated_batch} = SingularityLLM.BatchProcessing.get_batch(:anthropic, batch.id)
      
      # Cancel if needed
      {:ok, cancelled_batch} = SingularityLLM.BatchProcessing.cancel_batch(:anthropic, batch.id)
  """
  ...
  ## Examples
      ...
      {:ok, batch} = SingularityLLM.BatchProcessing.get_batch(:anthropic, "batch_abc123")
  ...
  ## Examples
      ...
      {:ok, batch} = SingularityLLM.BatchProcessing.cancel_batch(:anthropic, "batch_abc123")
