defmodule SingularityLLM.Cache.Strategy do
  @moduledoc """
  Behavior defining the caching strategy interface for SingularityLLM.

  This behavior is the cornerstone of SingularityLLM's dual-cache architecture, enabling
  ...
  SingularityLLM provides two strategies out of the box:

  - `SingularityLLM.Cache.Strategies.Production` - ETS-based runtime caching
  - `SingularityLLM.Cache.Strategies.Test` - Test-aware caching with file persistence
