defmodule SingularityLLM.API.FileAPI do
  @moduledoc """
  ...
  ## Examples
      ...
      # Gemini file upload
      {:ok, file} = SingularityLLM.API.FileAPI.upload_file(:gemini, "/path/to/file.txt", [])
      
      # OpenAI file upload (purpose extracted automatically)
      {:ok, file} = SingularityLLM.API.FileAPI.upload_file(:openai, "/path/to/file.txt", [purpose: "fine-tune"])
  """
