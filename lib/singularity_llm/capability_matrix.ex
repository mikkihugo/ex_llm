defmodule SingularityLLM.CapabilityMatrix do
  @moduledoc """
  Provider Capability Matrix generator for SingularityLLM.
  ...
  ## Usage
      ...
      SingularityLLM.CapabilityMatrix.export(:markdown)
      SingularityLLM.CapabilityMatrix.export(:html)
  """
  ...
  def export(:html) do
    ...
    <html>
    <head>
      <title>SingularityLLM Provider Capability Matrix</title>
      <style>
    ...
    <body>
      <h1>SingularityLLM Provider Capability Matrix</h1>
      <table>
        <tr>
          <th>Provider</th>
  ...
  defp check_implementation_status(provider, capability) do
    ...
    test_status = SingularityLLM.TestResultAggregator.get_test_status(provider, internal_cap)
