defmodule SingularityLLM.Capabilities do
  @moduledoc """
  Provider capability detection system for SingularityLLM.
  ...
  ## Examples
      ...
      iex> SingularityLLM.Capabilities.supports?(:anthropic, :vision)
      true
      
      iex> SingularityLLM.Capabilities.supports?(:ollama, :vision)
      false
  """
  ...
  ## Examples
      ...
      iex> SingularityLLM.Capabilities.get_capabilities(:anthropic)
  ...
  ## Examples
      ...
      iex> SingularityLLM.Capabilities.providers_with_capability(:vision)
  ...
  def configured_and_supports?(provider, capability) do
    SingularityLLM.configured?(provider) and supports?(provider, capability)
  end
