defmodule SingularityLLM.KnowledgeBase do
  @moduledoc """
  Knowledge Base management functionality for SingularityLLM.
  ...
  ## Examples
      ...
      {:ok, kb} = SingularityLLM.KnowledgeBase.create_knowledge_base(:gemini, "research_papers",
        display_name: "Research Papers Collection"
      )

      # Create with description and metadata
      {:ok, kb} = SingularityLLM.KnowledgeBase.create_knowledge_base(:gemini, "product_docs",
  ...
  ## Examples
      ...
      {:ok, response} = SingularityLLM.KnowledgeBase.list_knowledge_bases(:gemini)
  ...
  ## Examples
      ...
      {:ok, kb} = SingularityLLM.KnowledgeBase.get_knowledge_base(:gemini, "research_papers")
  ...
  ## Examples
      ...
      {:ok, result} = SingularityLLM.KnowledgeBase.delete_knowledge_base(:gemini, "old_research")
  ...
  ## Examples
      ...
      {:ok, doc} = SingularityLLM.KnowledgeBase.add_document(:gemini, "research_papers", %{
  ...
  ## Examples
      ...
      # List all documents
      {:ok, response} = SingularityLLM.KnowledgeBase.list_documents(:gemini, "research_papers")
  ...
  ## Examples
      ...
      {:ok, doc} = SingularityLLM.KnowledgeBase.get_document(:gemini, "research_papers", "doc_123")
  ...
  ## Examples
      ...
      {:ok, result} = SingularityLLM.KnowledgeBase.delete_document(:gemini, "research_papers", "doc_123")
  ...
  ## Examples
      ...
      {:ok, results} = SingularityLLM.KnowledgeBase.semantic_search(:gemini, "research_papers",
