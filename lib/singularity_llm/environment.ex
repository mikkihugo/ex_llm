defmodule SingularityLLM.Environment do
  @moduledoc """
  Centralized environment variable definitions and documentation for SingularityLLM.

  This module provides a single source of truth for all environment variables
  used throughout the SingularityLLM library, ensuring consistent naming and usage.
  ...
  ## Examples
      ...
      iex> SingularityLLM.Environment.api_key_var(:openai)
      "OPENAI_API_KEY"

      iex> SingularityLLM.Environment.api_key_var(:gemini)
  ...
  ## Examples
      ...
      iex> SingularityLLM.Environment.base_url_var(:openai)
  ...
  ## Examples
      ...
      iex> SingularityLLM.Environment.model_var(:anthropic)
  ...
  ## Examples
      ...
      iex> SingularityLLM.Environment.streaming_timeout_var(:anthropic)
      {"ANTHROPIC_STREAMING_TIMEOUT", 300_000}

      iex> SingularityLLM.Environment.streaming_timeout_var(:groq)
  ...
  ## Examples
      ...
      iex> SingularityLLM.Environment.get("OPENAI_API_KEY")
      "sk-..."

      iex> SingularityLLM.Environment.get("CUSTOM_VAR", "default")
      "default"
  """
  ...
  ## Examples
      ...
      iex> SingularityLLM.Environment.set?("OPENAI_API_KEY")
      true
  """
  def set?(var_name) do
  ...
  ## Examples
      ...
      iex> SingularityLLM.Environment.all_api_key_vars()
  ...
  ## Examples
      ...
      iex> SingularityLLM.Environment.provider_config(:openai)
      %{
        api_key: "sk-...",
  ...
  ## Examples
      ...
      iex> SingularityLLM.Environment.available_providers()
      [:openai, :anthropic]
  """
