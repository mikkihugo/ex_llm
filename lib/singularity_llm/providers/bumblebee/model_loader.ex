defmodule SingularityLLM.Providers.Bumblebee.ModelLoader do
  @moduledoc """
  ...
  alias SingularityLLM.Providers.Bumblebee.EXLAConfig

  @model_cache_dir Path.expand("~/.singularity_llm/models")
