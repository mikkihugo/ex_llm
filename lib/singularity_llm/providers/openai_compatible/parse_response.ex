defmodule SingularityLLM.Providers.OpenAICompatible.ParseResponse do
  @moduledoc """
  ...
  ## Example
      ...
      defmodule SingularityLLM.Providers.MyProvider.ParseResponse do
  ...
  defmacro __using__(opts) do
    ...
    quote do
      ...
      defp calculate_response_cost(cost_provider, model, enhanced_usage) do
        ...
        SingularityLLM.Core.Cost.calculate(cost_provider, full_model_name, %{
