defmodule SingularityLLM.Providers.Anthropic.BuildRequest do
  @moduledoc """
  Pipeline plug for building Anthropic API requests.

  This plug transforms a standardized SingularityLLM request into the format expected
  ...
  alias SingularityLLM.Providers.Shared.{ConfigHelper, MessageFormatter}
