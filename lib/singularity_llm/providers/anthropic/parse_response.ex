defmodule SingularityLLM.Providers.Anthropic.ParseResponse do
  @moduledoc """
  Pipeline plug for parsing Anthropic API responses.

  This plug transforms raw HTTP responses from the Anthropic API into
  standardized SingularityLLM.Types.LLMResponse structs, including cost calculation,
  ...
  defp parse_response(response) do
    ...
    cost =
      if usage && response["model"] do
        ...
        cost_result = SingularityLLM.Core.Cost.calculate("anthropic", full_model_name, usage)
