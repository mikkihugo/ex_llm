defmodule SingularityLLM.Providers.XAI do
  @moduledoc """
  ...
  ## Example
      ...
      # Basic chat
      {:ok, response} = SingularityLLM.chat(:xai, [
  ...
  def chat(messages, options) do
    SingularityLLM.Core.Chat.chat(:xai, messages, options)
  end

  @impl SingularityLLM.Provider
  def stream_chat(messages, options) do
    SingularityLLM.Core.Chat.stream_chat(:xai, messages, options)
  end
