defmodule SingularityLLM.Providers.OpenRouter do
  @moduledoc """
  OpenRouter API adapter for SingularityLLM.
  ...
  ### Using Environment Variables
      ...
      SingularityLLM.Providers.OpenRouter.chat(messages, config_provider: SingularityLLM.Infrastructure.ConfigProvider.Env)
  ...
  ### Using Static Configuration
      ...
      SingularityLLM.Providers.OpenRouter.chat(messages, config_provider: provider)
  """
  ...
  def chat(messages, options) do
    SingularityLLM.Core.Chat.chat(:openrouter, messages, options)
  end

  @impl SingularityLLM.Provider
  def stream_chat(messages, options) do
    SingularityLLM.Core.Chat.stream_chat(:openrouter, messages, options)
  end
  ...
  defp get_app_name(config) do
    Map.get(config, :app_name) || System.get_env("OPENROUTER_APP_NAME") || "SingularityLLM"
  end

  defp get_app_url(config) do
    Map.get(config, :app_url) || System.get_env("OPENROUTER_APP_URL") ||
      "https://github.com/3rdparty-integrations/singularity_llm"
  end
