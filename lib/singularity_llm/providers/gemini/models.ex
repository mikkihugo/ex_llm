defmodule SingularityLLM.Providers.Gemini.Models do
  @moduledoc """
  ...
  ## Examples
      ...
      # List all models
      {:ok, response} = SingularityLLM.Providers.Gemini.Models.list_models()
      
      # List with pagination
      {:ok, response} = SingularityLLM.Providers.Gemini.Models.list_models(page_size: 10)
      
      # Get next page
      {:ok, next_page} = SingularityLLM.Providers.Gemini.Models.list_models(page_token: response.next_page_token)
  """
  ...
  ## Examples
      ...
      {:ok, model} = SingularityLLM.Providers.Gemini.Models.get_model("gemini-2.0-flash")
  """
