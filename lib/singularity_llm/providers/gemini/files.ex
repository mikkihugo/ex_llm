defmodule SingularityLLM.Providers.Gemini.Files do
  @moduledoc """
  ...
  ## Examples
      ...
      {:ok, file} = SingularityLLM.Providers.Gemini.Files.upload_file("/path/to/image.png", display_name: "My Image")
  """
  ...
  ## Examples
      ...
      {:ok, file} = SingularityLLM.Providers.Gemini.Files.get_file("files/abc-123")
  """
  ...
  ## Examples
      ...
      {:ok, %{files: files, next_page_token: token}} = SingularityLLM.Providers.Gemini.Files.list_files(page_size: 10)
  """
  ...
  ## Examples
      ...
      :ok = SingularityLLM.Providers.Gemini.Files.delete_file("files/abc-123")
  """
  ...
  ## Examples
      ...
      {:ok, file} = SingularityLLM.Providers.Gemini.Files.wait_for_file("files/abc-123", timeout: 30_000)
  """
