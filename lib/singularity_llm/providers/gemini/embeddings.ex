defmodule SingularityLLM.Providers.Gemini.Embeddings do
  @moduledoc """
  ...
  ## Examples
      ...
      {:ok, embedding} = SingularityLLM.Providers.Gemini.Embeddings.embed_content("models/text-embedding-004", request)
  """
  ...
  ## Examples
      ...
      {:ok, embeddings} = SingularityLLM.Providers.Gemini.Embeddings.batch_embed_contents("models/text-embedding-004", requests)
  """
  ...
  ## Examples
      ...
      {:ok, embedding} = SingularityLLM.Providers.Gemini.Embeddings.embed_text("models/text-embedding-004", "Hello world")
  """
  ...
  ## Examples
      ...
      {:ok, embeddings} = SingularityLLM.Providers.Gemini.Embeddings.embed_texts("models/text-embedding-004", texts)
  """
