defmodule SingularityLLM.Providers.Gemini.Document do
  @moduledoc """
  ...
  @type t :: %__MODULE__{
          ...
          custom_metadata: [SingularityLLM.Providers.Gemini.Document.CustomMetadata.t()] | nil,
  ...
  defmodule CustomMetadata do
    ...
    @type t :: %__MODULE__{
            ...
            string_list_value: SingularityLLM.Providers.Gemini.Document.StringList.t() | nil
          }
  end
  ...
  defmodule MetadataFilter do
    ...
    @type t :: %__MODULE__{
            key: String.t(),
            conditions: [SingularityLLM.Providers.Gemini.Document.Condition.t()]
          }
  end
  ...
  defmodule QueryResult do
    ...
    @type t :: %__MODULE__{
            relevant_chunks: [SingularityLLM.Providers.Gemini.Document.RelevantChunk.t()]
          }
  end
