defmodule SingularityLLM.Providers.Gemini.QA do
  @moduledoc """
  ...
  ## Usage
      ...
      {:ok, response} = SingularityLLM.Providers.Gemini.QA.generate_answer(
  ...
  defmodule GenerateAnswerRequest do
    ...
    @type t :: %__MODULE__{
            ...
            grounding_source:
              SingularityLLM.Providers.Gemini.QA.GroundingPassages.t()
              | SingularityLLM.Providers.Gemini.QA.SemanticRetrieverConfig.t(),
  ...
  defmodule GenerateAnswerResponse do
    ...
    @type t :: %__MODULE__{
            ...
            input_feedback: SingularityLLM.Providers.Gemini.QA.InputFeedback.t() | nil
          }
  ...
  defmodule GroundingPassages do
    ...
    @type t :: %__MODULE__{
            passages: [SingularityLLM.Providers.Gemini.QA.GroundingPassage.t()]
          }
