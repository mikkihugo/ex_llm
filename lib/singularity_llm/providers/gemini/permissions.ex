defmodule SingularityLLM.Providers.Gemini.Permissions do
  @moduledoc """
  ...
  alias SingularityLLM.Infrastructure.Config
  ...
  defmodule Permission do
    ...
    @type t :: %__MODULE__{
            name: String.t() | nil,
            grantee_type: SingularityLLM.Providers.Gemini.Permissions.grantee_type() | nil,
            email_address: String.t() | nil,
            role: SingularityLLM.Providers.Gemini.Permissions.role()
          }
    ...
    def from_json(json) do
      %__MODULE__{
        name: json["name"],
        grantee_type: SingularityLLM.Providers.Gemini.Permissions.parse_grantee_type(json["granteeType"]),
        email_address: json["emailAddress"],
        role: SingularityLLM.Providers.Gemini.Permissions.parse_role(json["role"])
      }
    end
  end
