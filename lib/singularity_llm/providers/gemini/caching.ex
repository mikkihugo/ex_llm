defmodule SingularityLLM.Providers.Gemini.Caching do
  @moduledoc """
  ...
  alias SingularityLLM.Providers.Shared.ConfigHelper
  alias SingularityLLM.Providers.Gemini.Content.{Content, Part, Tool, ToolConfig}
  ...
  ## Examples
      ...
      {:ok, cached} = SingularityLLM.Providers.Gemini.Caching.create_cached_content(request)
  """
  ...
  ## Examples
      ...
      {:ok, %{cached_contents: contents}} = SingularityLLM.Providers.Gemini.Caching.list_cached_contents(page_size: 10)
  """
  ...
  ## Examples
      ...
      {:ok, cached} = SingularityLLM.Providers.Gemini.Caching.get_cached_content("cachedContents/abc-123")
  """
  ...
  ## Examples
      ...
      {:ok, updated} = SingularityLLM.Providers.Gemini.Caching.update_cached_content(
  ...
  ## Examples
      ...
      :ok = SingularityLLM.Providers.Gemini.Caching.delete_cached_content("cachedContents/abc-123")
  """
  ...
  defp get_config_provider(opts) do
    Keyword.get(
      opts,
      :config_provider,
      Application.get_env(:singularity_llm, :config_provider, SingularityLLM.Infrastructure.ConfigProvider.Default)
    )
  end
  ...
  defp build_headers do
    [
      ...
      {"User-Agent", "SingularityLLM/0.4.2 (Elixir)"}
    ]
  end
