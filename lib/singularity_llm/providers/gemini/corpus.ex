defmodule SingularityLLM.Providers.Gemini.Corpus do
  @moduledoc """
  ...
  ## Usage
      ...
      # Create a corpus
      {:ok, corpus} = SingularityLLM.Providers.Gemini.Corpus.create_corpus(%{
        display_name: "My Knowledge Base"
      }, oauth_token: "your-oauth-token")
      
      # List corpora
      {:ok, response} = SingularityLLM.Providers.Gemini.Corpus.list_corpora(%{
        page_size: 10
      }, oauth_token: "your-oauth-token")
      
      # Query a corpus
      {:ok, response} = SingularityLLM.Providers.Gemini.Corpus.query_corpus(
        "corpora/my-corpus",
        "search query",
        %{results_count: 5},
        oauth_token: "your-oauth-token"
      ...
      # Update corpus
      {:ok, corpus} = SingularityLLM.Providers.Gemini.Corpus.update_corpus(
        "corpora/my-corpus",
      ...
      # Delete corpus
      :ok = SingularityLLM.Providers.Gemini.Corpus.delete_corpus(
        "corpora/my-corpus",
        oauth_token: "your-oauth-token"
      )
  """
  ...
  defmodule QueryCorpusRequest do
    ...
    @type t :: %__MODULE__{
            name: String.t(),
            query: String.t(),
            metadata_filters: [SingularityLLM.Providers.Gemini.Corpus.MetadataFilter.t()],
  ...
  defmodule QueryCorpusResponse do
    ...
    @type t :: %__MODULE__{
            relevant_chunks: [SingularityLLM.Providers.Gemini.Corpus.RelevantChunk.t()]
          }
  ...
  defmodule MetadataFilter do
    ...
    @type t :: %__MODULE__{
            key: String.t(),
            conditions: [SingularityLLM.Providers.Gemini.Corpus.Condition.t()]
          }
  ...
  * `opts` - Options including OAuth2 token
  ...
  ## Examples
      ...
      {:ok, corpus} = SingularityLLM.Providers.Gemini.Corpus.get_corpus(
        "corpora/my-corpus",
        oauth_token: "your-oauth-token"
      )
  """
