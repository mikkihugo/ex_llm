defmodule SingularityLLM.Providers.Gemini.Tokens do
  @moduledoc """
  ...
  alias SingularityLLM.Providers.Gemini.Content.{Content, GenerateContentRequest}
  ...
  ## Examples
      ...
      {:ok, response} = SingularityLLM.Providers.Gemini.Tokens.count_tokens("gemini-2.0-flash", request)
