defmodule SingularityLLM.Providers.Shared.MessageFormatter do
  @moduledoc """
  Shared message formatting utilities for SingularityLLM adapters.
  ...
  def normalize_message_keys(messages) do
    ...
    if has_string_keys do
      ...
      SingularityLLM.Infrastructure.Logger.warning(
