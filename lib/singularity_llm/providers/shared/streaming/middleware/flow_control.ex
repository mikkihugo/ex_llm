defmodule SingularityLLM.Providers.Shared.Streaming.Middleware.FlowControl do
  @moduledoc """
  ...
  integrating with the SingularityLLM.Infrastructure.Streaming.FlowController to manage
  ...
  This middleware delegates flow control to the `SingularityLLM.Infrastructure.Streaming.FlowController`
  ...
  defp flow_control_supported? do
    ...
    try do
      ...
      Code.ensure_loaded?(SingularityLLM.Infrastructure.Streaming.FlowController) &&
        Code.ensure_loaded?(SingularityLLM.Infrastructure.Streaming.StreamBuffer)
    rescue
      _ -> false
    end
  end
