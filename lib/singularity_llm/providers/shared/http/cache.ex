defmodule SingularityLLM.Providers.Shared.HTTP.Cache do
  @moduledoc """
...
defmodule SingularityLLM.Providers.Shared.HTTP.Cache.Memory do
  @moduledoc """
...
defmodule SingularityLLM.Providers.Shared.HTTP.Cache.Disk do
  @moduledoc """
