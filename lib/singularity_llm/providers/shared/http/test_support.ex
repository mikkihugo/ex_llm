defmodule SingularityLLM.Providers.Shared.HTTP.TestSupport do
  @moduledoc """
  ...
  def setup_mock_responses(responses) do
    Application.put_env(:singularity_llm, :test_mock_responses, responses)
    :ok
  end
  ...
  def get_mock_response(provider, endpoint) do
    responses = Application.get_env(:singularity_llm, :test_mock_responses, %{})
  ...
  defmodule MockAdapter do
    ...
    def call(env, opts) do
      ...
      SingularityLLM.Providers.Shared.HTTP.TestSupport.capture_request(env)
