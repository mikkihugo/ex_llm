defmodule SingularityLLM.Providers.Shared.StreamingBehavior do
  @moduledoc """
  Shared streaming behavior and utilities for SingularityLLM adapters.
  ...
  @doc """
  Callback for parsing a streaming chunk into an SingularityLLM StreamChunk.
