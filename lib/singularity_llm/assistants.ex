defmodule SingularityLLM.Assistants do
  @moduledoc """
  OpenAI Assistants API functionality for SingularityLLM.
  ...
  ## Examples
      ...
      # Create an assistant
      {:ok, assistant} = SingularityLLM.Assistants.create_assistant(:openai,
        name: "Math Tutor",
      ...
      {:ok, thread} = SingularityLLM.Assistants.create_thread(:openai)
      
      # Add a message to the thread
      {:ok, message} = SingularityLLM.Assistants.create_message(:openai, thread.id, 
        "What is 2 + 2?")
      
      # Run the assistant
      {:ok, run} = SingularityLLM.Assistants.run_assistant(:openai, thread.id, assistant.id)
  """
  ...
  ## Examples
      ...
      # List all assistants
      {:ok, response} = SingularityLLM.Assistants.list_assistants(:openai)

      # List with pagination
      {:ok, response} = SingularityLLM.Assistants.list_assistants(:openai, limit: 10, order: "asc")
  ...
  ## Examples
      ...
      {:ok, assistant} = SingularityLLM.Assistants.get_assistant(:openai, "asst_abc123")
  ...
  ## Examples
      ...
      {:ok, assistant} = SingularityLLM.Assistants.update_assistant(:openai, "asst_abc123", %{
  ...
  ## Examples
      ...
      {:ok, result} = SingularityLLM.Assistants.delete_assistant(:openai, "asst_abc123")
  ...
  ## Examples
      ...
      {:ok, message} = SingularityLLM.Assistants.create_message(:openai, "thread_abc123", 
  ...
  ## Examples
      ...
      {:ok, run} = SingularityLLM.Assistants.run_assistant(:openai, "thread_abc123", "asst_abc123")
