defmodule SingularityLLM.Testing.OAuth2.Helper do
  @moduledoc """
  ...
  @providers %{
    google: SingularityLLM.Testing.OAuth2.Providers.Google,
    # Alias for backward compatibility
    gemini: SingularityLLM.Testing.OAuth2.Providers.Google,
    microsoft: SingularityLLM.Testing.OAuth2.Providers.Microsoft,
    github: SingularityLLM.Testing.OAuth2.Providers.GitHub
  }
  ...
  ## Examples
      ...
      iex> SingularityLLM.Testing.OAuth2.Helper.oauth_available?(:google)
      true
      
      iex> SingularityLLM.Testing.OAuth2.Helper.oauth_available?(:microsoft)
      false
  """
  ...
  ## Examples
      ...
      iex> SingularityLLM.Testing.OAuth2.Helper.get_valid_token(:google)
      {:ok, "ya29.a0AfH6SMBx..."}
      
      iex> SingularityLLM.Testing.OAuth2.Helper.get_valid_token(:invalid_provider)
  ...
  ## Examples
      ...
      iex> SingularityLLM.Testing.OAuth2.Helper.refresh_token(:google)
  ...
  ## Examples
      ...
      iex> SingularityLLM.Testing.OAuth2.Helper.setup_oauth(:google, %{})
  ...
  ## Examples
      ...
      iex> SingularityLLM.Testing.OAuth2.Helper.supported_providers()
  ...
  ## Examples
      ...
      iex> SingularityLLM.Testing.OAuth2.Helper.get_provider_config(:google)
