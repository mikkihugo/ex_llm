defmodule SingularityLLM.Testing.OAuth2.Providers.Microsoft do
  @moduledoc """
  Microsoft Azure AD OAuth2 provider implementation for SingularityLLM testing.

  This is a placeholder implementation for future Azure AD OAuth2 support.
  """

  @behaviour SingularityLLM.Testing.OAuth2.Provider
