defmodule SingularityLLM.Testing.TestCacheConfig do
  @moduledoc """
  Configuration for the SingularityLLM test caching system.
  ...
  defp merge_app_config(defaults) do
    app_config = Application.get_env(:singularity_llm, :test_cache, %{})
