defmodule SingularityLLM.Testing.CachingInterceptor do
  @moduledoc """
  ...
  ### Environment-based Auto-caching
      ...
      # Normal SingularityLLM usage will automatically cache responses
  ...
  ### Manual Caching Wrapper
      ...
      {:ok, response} = SingularityLLM.CachingInterceptor.with_caching(:openai, fn ->
        SingularityLLM.Providers.OpenAI.chat(messages)
      end)

  ### Batch Response Collection

      # Collect responses for testing scenarios
      SingularityLLM.CachingInterceptor.collect_test_responses(:openai, [
  ...
  alias SingularityLLM.Testing.MockResponseRecorder
