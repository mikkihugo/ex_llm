defmodule SingularityLLM.Testing.TestCacheHelpers do
  @moduledoc """
  ...
  alias SingularityLLM.Testing.TestCacheIndex
  alias SingularityLLM.Testing.TestCacheStats
  alias SingularityLLM.Testing.TestCacheStrategy
  alias SingularityLLM.Testing.TestCacheTimestamp
  ...
  def with_test_cache(opts \\ [], func) when is_function(func) do
    ...
    Application.put_env(:singularity_llm, :test_cache, temp_config)

    try do
      func.()
    after
      # Restore original config
      Application.put_env(:singularity_llm, :test_cache, original_config)
    end
  end
  ...
  def enable_cache_debug do
    Application.put_env(:singularity_llm, :debug_test_cache, true)
  ...
  def disable_cache_debug do
    Application.put_env(:singularity_llm, :debug_test_cache, false)
  ...
  ## Usage in test module:
      ...
      setup do
        SingularityLLM.Testing.TestCacheHelpers.setup_test_cache()
      end
  """
