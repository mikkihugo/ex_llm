defmodule SingularityLLM.Plugs.ValidateMessages do
  @moduledoc """
  Validates the message list in the request.

  This plug ensures that the `messages` field in the `SingularityLLM.Pipeline.Request`
  ...
  ## Examples
      ...
      plug SingularityLLM.Plugs.ValidateMessages
  """
