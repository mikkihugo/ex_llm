defmodule SingularityLLM.Plugs.ValidateProvider do
  ...
  ## Examples
      ...
      plug SingularityLLM.Plugs.ValidateProvider, providers: [:openai, :anthropic]
  """
  ...
  ## Examples
      ...
      iex> SingularityLLM.Plugs.ValidateProvider.supported_providers()
  ...
  ## Examples
      ...
      iex> SingularityLLM.Plugs.ValidateProvider.supported?(:openai)
      true
      
      iex> SingularityLLM.Plugs.ValidateProvider.supported?(:unknown)
      false
  """
