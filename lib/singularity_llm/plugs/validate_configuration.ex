defmodule SingularityLLM.Plugs.ValidateConfiguration do
  @moduledoc """
  ...
  for the provider. It's used by SingularityLLM.configured?/1 to determine if
  ...
  ## Examples
      ...
      plug SingularityLLM.Plugs.ValidateConfiguration
  ...
  defp validate_provider_config(provider, config) do
    case provider do
      ...
      :bumblebee ->
        ...
        case SingularityLLM.Providers.Bumblebee.configured?() do
          true ->
