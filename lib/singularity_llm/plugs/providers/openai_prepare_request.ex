defmodule SingularityLLM.Plugs.Providers.OpenAIPrepareRequest do
  @moduledoc """
  Prepares the request body for OpenAI API calls.

  This plug transforms the standardized SingularityLLM message format into
  ...
  ## Examples
      ...
      plug SingularityLLM.Plugs.Providers.OpenAIPrepareRequest
  """
