defmodule SingularityLLM.Plugs.Providers.OpenAIPrepareEmbeddingRequest do
  @moduledoc """
  Prepares embedding requests for the OpenAI API.

  Transforms the standardized SingularityLLM embedding request into OpenAI's specific
  ...
  def call(%SingularityLLM.Pipeline.Request{} = request, _opts) do
    ...
    |> SingularityLLM.Pipeline.Request.assign(:http_method, :post)
    |> SingularityLLM.Pipeline.Request.assign(:http_path, "/embeddings")
  end
