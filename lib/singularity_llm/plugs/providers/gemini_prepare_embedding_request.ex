defmodule SingularityLLM.Plugs.Providers.GeminiPrepareEmbeddingRequest do
  @moduledoc """
  Prepares embedding requests for the Gemini API.

  Transforms the standardized SingularityLLM embedding request into Gemini's specific
  ...
  def call(%SingularityLLM.Pipeline.Request{} = request, _opts) do
    ...
    |> SingularityLLM.Pipeline.Request.assign(
      :http_path,
