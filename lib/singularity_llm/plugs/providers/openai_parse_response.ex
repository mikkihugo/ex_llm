defmodule SingularityLLM.Plugs.Providers.OpenAIParseResponse do
  @moduledoc """
  Parses the response from OpenAI API calls.

  This plug transforms the OpenAI-specific response format into
  the standardized SingularityLLM response format.
  ...
  ## Examples
      ...
      plug SingularityLLM.Plugs.Providers.OpenAIParseResponse
  """
