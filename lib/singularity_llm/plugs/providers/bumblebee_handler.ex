defmodule SingularityLLM.Plugs.Providers.BumblebeeHandler do
  @moduledoc """
  ...
  alias SingularityLLM.{Pipeline.Request, Types}
  ...
  defp handle_chat_request(request, messages, config) do
    ...
    case SingularityLLM.Providers.Bumblebee.chat(messages, opts) do
  ...
  defp handle_streaming_request(request, messages, config) do
    ...
    case SingularityLLM.Providers.Bumblebee.stream_chat(messages, opts) do
      {:ok, stream} ->
