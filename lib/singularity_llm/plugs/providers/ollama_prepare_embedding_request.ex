defmodule SingularityLLM.Plugs.Providers.OllamaPrepareEmbeddingRequest do
  @moduledoc """
  Prepares embedding requests for the Ollama API.

  Transforms the standardized SingularityLLM embedding request into Ollama's specific
