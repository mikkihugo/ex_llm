defmodule SingularityLLM.TestPlugs do
  @moduledoc """
  Collection of mock plugs for testing SingularityLLM pipelines.
  ...
  defmodule MockSuccess do
    ...
    ## Examples
        ...
        # Simple success
        plug SingularityLLM.TestPlugs.MockSuccess
        
        # With custom result
        plug SingularityLLM.TestPlugs.MockSuccess, result: %{content: "Hello!"}
  ...
  defmodule MockError do
    ...
    ## Examples
        ...
        # Simple error
        plug SingularityLLM.TestPlugs.MockError
  ...
  defmodule MockDelay do
    ...
    ## Examples
        ...
        # Short delay
        plug SingularityLLM.TestPlugs.MockDelay, delay_ms: 50
        
        # Long delay that might trigger timeouts
        plug SingularityLLM.TestPlugs.MockDelay, delay_ms: 5000
    """
  ...
  defmodule MockHttpResponse do
    ...
    ## Examples
        ...
        # Success response
        plug SingularityLLM.TestPlugs.MockHttpResponse,
          status: 200,
  ...
  defmodule MockCounter do
    ...
    ## Usage
        ...
        # Use in pipeline
        plug SingularityLLM.TestPlugs.MockCounter, name: :test_counter
