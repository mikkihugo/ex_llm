defmodule SingularityLLM.Providers do
  @moduledoc """
  ...
  defp groq_chat_pipeline do
    ...
    [
      ...
      Plugs.FetchConfiguration,
      {Plugs.ManageContext, strategy: :truncate},
      SingularityLLM.Providers.Groq.BuildRequest,
      Plugs.BuildTeslaClient,
      {Plugs.Cache, ttl: 300},
      Plugs.ExecuteRequest,
      SingularityLLM.Providers.Groq.ParseResponse,
      Plugs.TrackCost
    ]
  end
  ...
  defp openrouter_chat_pipeline do
    ...
    [
      ...
      Plugs.BuildTeslaClient,
      {Plugs.Cache, ttl: 300},
      SingularityLLM.Providers.OpenRouter.BuildRequest,
      Plugs.ExecuteRequest,
      Plugs.Providers.OpenAIParseResponse,
      Plugs.TrackCost
    ]
  ...
  This is useful for extending SingularityLLM with custom providers or
  overriding default pipelines.

  ## Examples

      SingularityLLM.Providers.register_pipeline(:my_provider, :chat, [
