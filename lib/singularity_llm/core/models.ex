defmodule SingularityLLM.Core.Models do
  @moduledoc """
  ...
  and discovery across all SingularityLLM providers.
  """
  ...
  ## Examples
      ...
      iex> SingularityLLM.Core.Models.list_all()
      {:ok, [
  ...
  ## Examples
      ...
      iex> SingularityLLM.Core.Models.list_for_provider(:anthropic)
      {:ok, [
  ...
  def list_for_provider(provider) do
    ...
    pipeline = SingularityLLM.Providers.get_pipeline(provider, :list_models)

    # Create a request for list_models operation
    request = SingularityLLM.Pipeline.Request.new(provider, [], %{operation: :list_models})

    # Run the pipeline
    case SingularityLLM.Pipeline.run(request, pipeline) do
      %SingularityLLM.Pipeline.Request{state: :completed, result: {:ok, models}} ->
        {:ok, models}

      %SingularityLLM.Pipeline.Request{state: :error, errors: errors} ->
  ...
  ## Examples
      ...
      iex> SingularityLLM.Core.Models.get_info(:anthropic, "claude-3-5-sonnet-20241022")
      {:ok, %{
  ...
  ## Examples
      ...
      iex> SingularityLLM.Core.Models.find_by_capabilities([:vision, :streaming])
      {:ok, [
        %{provider: :anthropic, id: "claude-3-5-sonnet-20241022", ...},
        %{provider: :openai, id: "gpt-4-turbo", ...}
      ]}
  ...
  ## Examples
      ...
      iex> SingularityLLM.Core.Models.find_by_min_context(100_000)
  ...
  ## Examples
      ...
      iex> SingularityLLM.Core.Models.find_by_cost_range(input: {0, 5.0}, output: {0, 20.0})
  ...
  ## Examples
      ...
      iex> SingularityLLM.Core.Models.get_default(:anthropic)
  ...
  ## Examples
      ...
      iex> SingularityLLM.Core.Models.compare(["claude-3-5-sonnet-20241022", "gpt-4-turbo", "gemini-1.5-pro"])
      {:ok, %{
        models: [...],
