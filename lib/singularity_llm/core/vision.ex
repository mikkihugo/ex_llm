defmodule SingularityLLM.Core.Vision do
  @moduledoc """
  Vision and multimodal support for SingularityLLM.
  ...
  ## Examples
      ...
      message = SingularityLLM.Core.Vision.build_message("user", "What's in these images?", [
  ...
  ## Examples
      ...
      {:ok, message} = SingularityLLM.Core.Vision.create_message("What's in this image?", ["https://example.com/img.jpg"])
  """
