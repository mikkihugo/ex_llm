defmodule SingularityLLM.Core.FunctionCalling do
  @moduledoc """
  Function calling support for SingularityLLM.
  ...
  ## Examples
      ...
      {:ok, args} = SingularityLLM.Core.FunctionCalling.parse_arguments("{\"location\": \"NYC\"}")
      # => {:ok, %{"location" => "NYC"}}
  """
