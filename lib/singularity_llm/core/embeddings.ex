defmodule SingularityLLM.Core.Embeddings do
  @moduledoc """
  ...
  ## Examples
      ...
      # Single text
      {:ok, response} = SingularityLLM.Core.Embeddings.generate(:openai, "Hello world")
      
      # Multiple texts
      {:ok, response} = SingularityLLM.Core.Embeddings.generate(:openai, ["Hello", "World"])
      
      # With options
      {:ok, response} = SingularityLLM.Core.Embeddings.generate(:openai, "Hello", 
  ...
  ## Examples
      ...
      {:ok, models} = SingularityLLM.Core.Embeddings.list_models(:openai)
  ...
  ## Examples
      ...
      {:ok, info} = SingularityLLM.Core.Embeddings.get_model_info(:openai, "text-embedding-3-large")
      # => %{
  ...
  ## Examples
      ...
      providers = SingularityLLM.Core.Embeddings.list_providers()
  ...
  ## Examples
      ...
      similarity = SingularityLLM.Core.Embeddings.similarity(vector1, vector2)
      # => 0.8234
      
      similarity = SingularityLLM.Core.Embeddings.similarity(vector1, vector2, :euclidean)
      # => 0.1234
  ...
  ## Examples
      ...
      {:ok, cost} = SingularityLLM.Core.Embeddings.estimate_cost(:openai, ["text1", "text2"], 
        model: "text-embedding-3-large"
      )
  ...
  ## Examples
      ...
      {:ok, results} = SingularityLLM.Core.Embeddings.batch_generate(:openai, requests)
  ...
  ## Examples
      ...
      results = SingularityLLM.Core.Embeddings.find_similar(query_embedding, items, top_k: 5)
  """
  ...
  ## Examples
      ...
      {:ok, models} = SingularityLLM.Core.Embeddings.list_embedding_models(:openai)
  """
