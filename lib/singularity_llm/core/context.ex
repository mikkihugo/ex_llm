defmodule SingularityLLM.Core.Context do
  @moduledoc """
  ...
  alias SingularityLLM.{Core.Cost, Infrastructure.Config.ModelConfig}
  ...
  ## Examples
      ...
      stats = SingularityLLM.Core.Context.stats(messages)
  """
