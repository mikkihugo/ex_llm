defmodule SingularityLLM.Core.Cost do
  @moduledoc """
  Cost calculation functionality for SingularityLLM.

  Provides token estimation, cost calculation, and pricing information
  for all supported LLM providers.
  """

  alias SingularityLLM.{Infrastructure.Config.ModelConfig, Types}
  ...
  ## Examples
      ...
      iex> SingularityLLM.Core.Cost.format(0.0045)
      "$0.004500"

      iex> SingularityLLM.Core.Cost.format(0.0045, style: :detailed)
      "$0.004500"

      iex> SingularityLLM.Core.Cost.format(1234.56, style: :auto)
      "$1,234.56"

      iex> SingularityLLM.Core.Cost.format(0.1234, precision: 3)
      "$0.123"
  """
