defmodule SingularityLLM.Core.Streaming.Recovery do
  @moduledoc """
  Streaming error recovery and resumption support for SingularityLLM.
  ...
  ## Usage
      ...
      {:ok, stream} = SingularityLLM.stream_chat(:anthropic, messages,
        recovery: [
          enabled: true,
          strategy: :paragraph,
          storage: :memory
      ...
      {:ok, resumed_stream} = SingularityLLM.Core.Streaming.Recovery.resume_stream(recovery_id)
  """
