defmodule SingularityLLM.Tesla.Middleware.Telemetry do
  ...
  The following events are emitted:
    ...
    * `[:singularity_llm, :http, :start]` - Request started
    * `[:singularity_llm, :http, :stop]` - Request completed successfully
    * `[:singularity_llm, :http, :error]` - Request failed
  ...
  ## Examples
      ...
      plug SingularityLLM.Tesla.Middleware.Telemetry,
