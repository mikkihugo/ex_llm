defmodule SingularityLLM.Benchmark do
  @moduledoc """
  Benchmarking utilities for SingularityLLM pipeline performance.
  ...
  ## Usage
      ...
      SingularityLLM.Benchmark.run_chat_benchmark(:openai, messages)
      
      # Benchmark pipeline with different configurations
      SingularityLLM.Benchmark.compare_pipelines([
        {:baseline, SingularityLLM.Providers.get_pipeline(:openai, :chat)},
        {:optimized, optimized_pipeline()}
      ])
      
      # Profile memory usage
      SingularityLLM.Benchmark.profile_memory(fn ->
  ...
  ## Examples
      ...
      results = SingularityLLM.Benchmark.compare_pipelines(pipelines, messages)
  """
