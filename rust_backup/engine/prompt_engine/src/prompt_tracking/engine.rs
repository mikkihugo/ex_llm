...
use crate::{FactError, Result, Template, RegistryTemplate};
...
impl EngineFact {
  ...
  async fn execute_storage_template(
    ...
    use crate::storage::{create_storage, FactData, FactKey, ConfigStorage};
    ...
    let storage_config = ConfigStorage::default();
