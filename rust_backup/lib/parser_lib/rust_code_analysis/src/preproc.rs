...
use petgraph::{algo::kosaraju_scc, graph::NodeIndex, stable_graph::StableGraph, visit::Dfs, Direction};
use serde::{Deserialize, Serialize};

use crate::{c_langs_macros::is_specials, langs::*, languages::language_preproc::*, tools::*, traits::*};
...
pub fn get_macros<S: ::std::hash::BuildHasher>(file: &Path, files: &HashMap<PathBuf, PreprocFile, S>) -> HashSet<String> {
...
pub fn fix_includes<S: ::std::hash::BuildHasher>(files: &mut HashMap<PathBuf, PreprocFile, S>, all_files: &HashMap<String, Vec<PathBuf>, S>) {
