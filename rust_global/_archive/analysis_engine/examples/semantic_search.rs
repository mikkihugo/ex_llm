...
use code_engine::codebase::{CodebaseDatabase, FileAnalysis, CodebaseMetadata};
use code_engine::embeddings::HybridConfig;

#[cfg(feature = "semantic")]
use code_engine::embeddings::CandleTransformer;
...
fn main() -> anyhow::Result<()> {
    ...
    #[cfg(feature = "semantic")]
    {
        use code_engine::codebase::GlobalSemanticCache;
