...
graph TD
    ...
    L -->|Yes| M[Broadcast via quantum_flow<br/>Consensus.execute_if_consensus/1]
...
sequenceDiagram
    ...
    alt Consensus Reached (3+ instances, 95%+ success)
        ...
        PA->>G: Promote to Genesis<br/>(via quantum_flow)
...
sequenceDiagram
    ...
    participant DB as CentralCloud DB
    participant I as Instance (via quantum_flow)
    ...
    loop Every 30 seconds
        ...
        alt Threshold Breached
            ...
            G->>I: Broadcast rollback command<br/>(via quantum_flow queue)
...
sequenceDiagram
    ...
    participant PG as quantum_flow Queue
