...
//! 2. package_intelligence: External facts (GitHub, npm, CVEs)
//!
...
pub struct SparcKnowledge {
    ...
    /// External facts (from package_intelligence) - currently a stub
    facts: PackageIntelligenceBridge,
}
...
impl SparcKnowledge {
    ...
    pub fn new(project_id: impl Into<String>) -> Result<Self> {
        Ok(Self {
            ...
            facts: PackageIntelligenceBridge::new()?,
        })
    }
...
/// Bridge to package_intelligence
///
/// This is a stub implementation that returns empty results.
/// To enable package_intelligence integration:
/// 1. Add `package_intelligence` crate dependency
/// 2. Replace this stub with actual package_intelligence queries
/// 3. Use package_intelligence's PackageRegistry to query external facts
struct PackageIntelligenceBridge;

impl PackageIntelligenceBridge {
    fn new() -> Result<Self> {
        Ok(Self)
    }
    ...
    async fn search_github_examples(&self, _query: &str) -> Result<Vec<GitHubExample>> {
        ...
        // Real implementation would query package_intelligence's GitHub repository facts
        Ok(Vec::new())
    }

    async fn search_npm_packages(&self, _query: &str) -> Result<Vec<NpmPackage>> {
        // Stub: Returns empty results
        // Real implementation would query package_intelligence's npm package facts
        Ok(Vec::new())
    }

    async fn search_vulnerabilities(&self, _query: &str) -> Result<Vec<SecurityAdvisory>> {
        // Stub: Returns empty results
        // Real implementation would query package_intelligence's security advisory facts
        Ok(Vec::new())
    }
}
