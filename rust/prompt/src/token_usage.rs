...
mod tests {
    ...
    fn test_lm_usage_with_all_fields() {
        let usage = LanguageModelUsageMetrics::with_all_fields(
            100,
            50,
            Some(25),
    ...
    fn test_lm_usage_add_provider_selection() {
        let usage1 = LanguageModelUsageMetrics::with_all_fields(
            100,
            50,
            None,
            Some("claude".to_string()),
        ...
        let usage2 = LanguageModelUsageMetrics::with_all_fields(
            200,
            75,
            None,
            Some("gpt4".to_string()),
        ...
        let usage4 = LanguageModelUsageMetrics::with_all_fields(
            200,
            75,
            None,
