...
use super::detector::{FrameworkPattern, FrameworkCategory};
...
impl BuiltinPatterns {
    ...
    fn spring_pattern() -> FrameworkPattern {
        FrameworkPattern {
            ...
            weight: 1.0,
            version_patterns: vec![
                r#"spring-boot-starter["']?\s*:\s*["']([^"']+)["']"#.to_string(),
            ],
        }
    }
