//! SPARC Codebase Analysis Library
//!
...
//! - **CodePattern Detection**: Design patterns, anti-patterns, code smells
...
//! let design_patterns = patterns.design_patterns;
//!
...
//! - **External Parsers**: Uses external crates for code parsing
