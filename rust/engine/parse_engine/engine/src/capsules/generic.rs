...
/// Represents a generic language capsule for parsing plain text or markdown files.
/// This capsule is used as a fallback for unsupported or unrecognized file types.
