...
export type CodexMessageType = AgentReasoningMessage | AgentMessage | TaskCompleteMessage | TaskStartedMessage | ExecCommandBeginMessage | ExecCommandEndMessage | SessionConfiguredMessage | BackgroundEventMessage | ExecApprovalRequestMessage | ErrorMessage | McpToolCallBeginMessage | McpToolCallEndMessage | ApplyPatchApprovalRequestMessage | PatchApplyBeginMessage | PatchApplyEndMessage | GetHistoryEntryResponseMessage;
export declare enum CodexMessageTypeEnum {
...
export type CodexOperationType = UserInputOperation | ExecApprovalOperation | ConfigureSessionOperation | InterruptOperation | PatchApprovalOperation | AddToHistoryOperation | GetHistoryEntryRequestOperation;
...
export declare enum ModelReasoningEffort {
    NONE = "none",
    LOW = "low",
    MEDIUM = "medium",
    HIGH = "high"
}
export declare enum ModelReasoningSummary {
    NONE = "none",
    AUTO = "auto",
    CONCISE = "concise",
    DETAILED = "detailed"
...
export declare enum EnvironmentInheritPolicy {
    CORE = "core",
    ALL = "all",
    NONE = "none"
}
export declare enum FileOpener {
    VSCODE = "vscode",
...
export declare enum HistoryPersistence {
    NONE = "none",
    SAVE_ALL = "save-all"
}
...
export declare enum AskForApproval {
    UNLESS_ALLOW_LISTED = "unless-allow-listed",
    AUTO_EDIT = "auto-edit",
    ON_FAILURE = "on-failure",
    NEVER = "never"
}
export declare enum SandboxPermission {
