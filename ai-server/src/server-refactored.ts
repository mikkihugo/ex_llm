...
import { copilot, COPILOT_MODELS } from './providers/copilot';
...
const MODELS = buildModelCatalog({
  ...
  'google-jules': julesWithModels as unknown as ProviderWithModels,
  'github-copilot': copilot as unknown as ProviderWithMetadata,
  'github-models': githubModels as unknown as ProviderWithMetadata,
});

console.log(`${blue}✨${reset} AI SDK Provider Registry initialized`);
...
async function ensureModelCatalogLoaded(): Promise<void> {
  ...
  // Simple catalog loading (unchanged)
