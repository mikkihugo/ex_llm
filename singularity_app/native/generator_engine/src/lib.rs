...
// Re-export pseudocode generator
pub use pseudocode_generator::{
    PseudocodeGenerator, PseudocodeElement, PseudocodeFunction, 
    PseudocodeModule, PseudocodeVariable, PseudocodeType
};

// Re-export code generator
pub use code_generator::{
    CodeGenerator, CodeElement, CodeFunction, CodeModule, CodeVariable
};

// Local stub definitions to replace code_engine dependencies
