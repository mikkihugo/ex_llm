...
pub enum PromptResult {
  Success { files_created: Vec<String>, files_modified: Vec<String>, commands_run: Vec<String>, duration_ms: u64 },
  Failure { error: String, stage: FailureStage, attempted_commands: Vec<String> },
}
