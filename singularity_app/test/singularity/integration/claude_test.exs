defmodule Singularity.Integration.ClaudeTest do
  ...
  describe "chat/2 with mocked CLI (unit)" do
    test "successfully chats with simple prompt" do
      ...
      Application.put_env(:singularity, :claude, cli_path: mock_cli)

      on_exit(fn ->
        MockCLI.cleanup(mock_cli)
        Application.delete_env(:singularity, :claude)
      end)
    ...
    test "handles CLI errors gracefully" do
      ...
      Application.put_env(:singularity, :claude, cli_path: "/nonexistent/binary")
      on_exit(fn -> Application.delete_env(:singularity, :claude) end)
  ...
  describe "end-to-end with real CLI" do
    ...
    setup do
      ...
      if has_cli and has_auth do
        Application.put_env(:singularity, :claude, cli_path: cli_path)
        on_exit(fn -> Application.delete_env(:singularity, :claude) end)
