defmodule Singularity.EmbeddingService do
  @moduledoc """
  Unified Embedding Service - Generate embeddings from multiple providers
  ...
  ## Usage
      ...
      # Generate embedding
      {:ok, embedding} = EmbeddingService.embed("some text")

      # With specific provider
      {:ok, embedding} = EmbeddingService.embed("text", provider: :bumblebee)
  """
