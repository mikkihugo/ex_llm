defmodule Singularity.ServiceManagement.DocGenerator do
  @moduledoc """
  Generates comprehensive documentation for singularity-engine services,
  including API docs, architecture diagrams, and implementation guides.
  """
