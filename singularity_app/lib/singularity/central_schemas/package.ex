defmodule Singularity.CentralSchemas.Package do
  @moduledoc """
  ...
  schema "central_packages" do
    ...
    # Relationships
    has_many :code_snippets, Singularity.CentralSchemas.CodeSnippet
    has_many :security_advisories, Singularity.CentralSchemas.SecurityAdvisory
    has_many :analysis_results, Singularity.CentralSchemas.AnalysisResult
    has_many :package_examples, Singularity.CentralSchemas.PackageExample
    has_many :prompt_templates, Singularity.CentralSchemas.PromptTemplate
