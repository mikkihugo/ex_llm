defmodule Singularity.ServiceManagement.HealthMonitor do
  @moduledoc """
  Monitors health and performance of singularity-engine services,
  detects failures, and triggers automatic recovery procedures.
  """
