defmodule Singularity.Planning.HTDAGBootstrap do
  ...
  defp build_codebase_understanding do
    ...
    knowledge_artifacts = case knowledge do
  ...
  defp analyze_existing_systems do
    ...
    systems = %{
      ...
      sparc_orchestrator: check_module_available(TemplateSparcOrchestrator),
  ...
  defp create_integration_dag(codebase_knowledge, system_analysis) do
    ...
    goal = %{
      ...
      - TemplateSparcOrchestrator: Integrate SPARC methodology
  ...
  defp identify_missing_integrations do
    ...
    missing = if not htdag_integrated_with_self_improving?() do
    ...
    missing = if not htdag_integrated_with_safe_planner?() do
    ...
    missing = if not htdag_uses_rag?() do
