defmodule Singularity.Planning.Supervisor do
  @moduledoc """
  ...
  - `Singularity.Planning.HTDAGAutoBootstrap` - GenServer for HTDAG self-diagnosis/auto-fix
  - `Singularity.Planning.SafeWorkPlanner` - GenServer for SAFe methodology planning
  - `Singularity.Planning.WorkPlanAPI` - GenServer providing work plan API

  ## Important Notes

  `Singularity.Planning.HTDAG` is NOT supervised here because it's a plain module
