defmodule Singularity.SPARC.Supervisor do
  @moduledoc """
  ...
  - `Singularity.SPARC.Orchestrator` - GenServer orchestrating SPARC workflows
  - `Singularity.TemplateSparcOrchestrator` - GenServer for template-driven SPARC execution
