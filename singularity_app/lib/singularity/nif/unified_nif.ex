defmodule Singularity.UnifiedNif do
  @moduledoc """
  Unified Analysis NIF - Main analysis engine for Singularity
  ...
  ## Examples
      ...
      iex> Singularity.UnifiedNif.analyze_codebase("/path/to/project")
      %{
        success: true,
        technologies: [...],
        dependencies: [...],
  ...
  ## Examples
      ...
      iex> Singularity.UnifiedNif.detect_technologies("/path/to/project")
      [
  ...
  ## Examples
      ...
      iex> Singularity.UnifiedNif.parse_dependencies("/path/to/project")
      [
  ...
  ## Examples
      ...
      iex> Singularity.UnifiedNif.generate_embeddings("/path/to/project", "text-embedding-004")
      [
  ...
  ## Examples
      ...
      iex> Singularity.UnifiedNif.analyze_quality("/path/to/project")
      %{
  ...
  ## Examples
      ...
      iex> Singularity.UnifiedNif.analyze_security("/path/to/project")
      [
  ...
  ## Examples
      ...
      iex> Singularity.UnifiedNif.analyze_architecture("/path/to/project")
      [
  ...
  ## Examples
      ...
      iex> Singularity.UnifiedNif.get_analysis_summary("/path/to/project")
      %{
        "total_files" => "150",
        "total_lines" => "12500",
  ...
  ## Examples
      ...
      iex> Singularity.UnifiedNif.write_to_database(result, "postgresql://localhost/singularity")
      true
  """
